...
static class CompoundSourceIndividual extends AbstractIndividual {
	...
	@Override
	public CompoundSource setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/CompoundSource";
...
this.investigationRestriction = compoundSource.investigationRestriction;
...
this.textMention = compoundSource.getTextMention();
	...
	public CompoundSource(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
@Override
public String toString(){
return "CompoundSource [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
