...
@DirectInterface(get=IVentralHemisection.class)
 public class VentralHemisection implements IVentralHemisection{

final public static IndividualFactory<VentralHemisectionIndividual> individualFactory = new IndividualFactory<>();
final public static Class<? extends AbstractIndividual> individualClassType = VentralHemisectionIndividual.class;
static class VentralHemisectionIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public VentralHemisectionIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "VentralHemisectionIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<VentralHemisectionIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final VentralHemisectionIndividual individual;
	@Override
	...
	@Override
	public VentralHemisection setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/VentralHemisection";
...
final private String textMention;
	...
	public VentralHemisection(){
this.individual = null;
this.investigationRestriction = InvestigationRestriction.noRestrictionInstance;
this.textMention = null;
}
	public VentralHemisection(VentralHemisection ventralHemisection)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
this.individual = ventralHemisection.individual;
this.investigationRestriction = ventralHemisection.investigationRestriction;
for (int j = 0; j < ventralHemisection.getAnimalCareConditions().size(); j++) {if (ventralHemisection.getAnimalCareConditions().get(j) != null) {animalCareConditions.add((IAnimalCareCondition) IOBIEThing.getCloneConstructor(ventralHemisection.getAnimalCareConditions().get(j).getClass()).newInstance(ventralHemisection.getAnimalCareConditions().get(j)));} else {animalCareConditions.add(null);}}
this.characterOffset = ventralHemisection.getCharacterOffset();
this.characterOnset = ventralHemisection.getCharacterOnset();
for (int j = 0; j < ventralHemisection.getInjuryAnaesthesiaAnaesthetics().size(); j++) {if (ventralHemisection.getInjuryAnaesthesiaAnaesthetics().get(j) != null) {injuryAnaesthesiaAnaesthetics.add((IAnaesthetic) IOBIEThing.getCloneConstructor(ventralHemisection.getInjuryAnaesthesiaAnaesthetics().get(j).getClass()).newInstance(ventralHemisection.getInjuryAnaesthesiaAnaesthetics().get(j)));} else {injuryAnaesthesiaAnaesthetics.add(null);}}
if(ventralHemisection.getInjuryArea()!=null)this.injuryArea = (IInjuryArea) IOBIEThing.getCloneConstructor(ventralHemisection.getInjuryArea().getClass())	.newInstance(ventralHemisection.getInjuryArea());
if(ventralHemisection.getInjuryDevice()!=null)this.injuryDevice = (IInjuryDevice) IOBIEThing.getCloneConstructor(ventralHemisection.getInjuryDevice().getClass())	.newInstance(ventralHemisection.getInjuryDevice());
if(ventralHemisection.getInjuryIntensity()!=null)this.injuryIntensity = (IInjuryIntensity) IOBIEThing.getCloneConstructor(ventralHemisection.getInjuryIntensity().getClass())	.newInstance(ventralHemisection.getInjuryIntensity());
for (int j = 0; j < ventralHemisection.getInjuryPostsurgicalCareAnimalCareConditions().size(); j++) {if (ventralHemisection.getInjuryPostsurgicalCareAnimalCareConditions().get(j) != null) {injuryPostsurgicalCareAnimalCareConditions.add((IAnimalCareCondition) IOBIEThing.getCloneConstructor(ventralHemisection.getInjuryPostsurgicalCareAnimalCareConditions().get(j).getClass()).newInstance(ventralHemisection.getInjuryPostsurgicalCareAnimalCareConditions().get(j)));} else {injuryPostsurgicalCareAnimalCareConditions.add(null);}}
if(ventralHemisection.getInjuryVertebralLocation()!=null)this.injuryVertebralLocation = (IVertebralLocation) IOBIEThing.getCloneConstructor(ventralHemisection.getInjuryVertebralLocation().getClass())	.newInstance(ventralHemisection.getInjuryVertebralLocation());
for (int j = 0; j < ventralHemisection.getMedicationDuringSurgeries().size(); j++) {if (ventralHemisection.getMedicationDuringSurgeries().get(j) != null) {medicationDuringSurgeries.add((IMedicationDuringSurgery) IOBIEThing.getCloneConstructor(ventralHemisection.getMedicationDuringSurgeries().get(j).getClass()).newInstance(ventralHemisection.getMedicationDuringSurgeries().get(j)));} else {medicationDuringSurgeries.add(null);}}
for (int j = 0; j < ventralHemisection.getTemporalIntervals().size(); j++) {if (ventralHemisection.getTemporalIntervals().get(j) != null) {temporalIntervals.add((ITemporalInterval) IOBIEThing.getCloneConstructor(ventralHemisection.getTemporalIntervals().get(j).getClass()).newInstance(ventralHemisection.getTemporalIntervals().get(j)));} else {temporalIntervals.add(null);}}
this.textMention = ventralHemisection.getTextMention();
}
	public VentralHemisection(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
				VentralHemisection.individualFactory.getIndividualByURI(individualURI);
...
<p>*/
@Override
	public VentralHemisection addAnimalCareCondition(IAnimalCareCondition animalCareCondition){
...
<p>*/
@Override
	public VentralHemisection addInjuryAnaesthesiaAnaesthetic(IAnaesthetic anaesthetic){
...
<p>*/
@Override
	public VentralHemisection addInjuryPostsurgicalCareAnimalCareCondition(IAnimalCareCondition animalCareCondition){
...
<p>*/
@Override
	public VentralHemisection addMedicationDuringSurgery(IMedicationDuringSurgery medicationDuringSurgery){
...
<p>*/
@Override
	public VentralHemisection addTemporalInterval(ITemporalInterval temporalInterval){
...
return false;
VentralHemisection other = (VentralHemisection) obj;
if (individual == null) {
...
<p>*/
@Override
	public VentralHemisection setAnimalCareConditions(List<IAnimalCareCondition> animalCareConditions){
...
<p>*/
@Override
	public VentralHemisection setInjuryAnaesthesiaAnaesthetics(List<IAnaesthetic> anaesthetics){
...
<p>*/
@Override
	public VentralHemisection setInjuryArea(IInjuryArea injuryArea){
...
<p>*/
@Override
	public VentralHemisection setInjuryDevice(IInjuryDevice injuryDevice){
...
<p>*/
@Override
	public VentralHemisection setInjuryIntensity(IInjuryIntensity injuryIntensity){
...
<p>*/
@Override
	public VentralHemisection setInjuryPostsurgicalCareAnimalCareConditions(List<IAnimalCareCondition> animalCareConditions){
...
<p>*/
@Override
	public VentralHemisection setInjuryVertebralLocation(IVertebralLocation vertebralLocation){
...
<p>*/
@Override
	public VentralHemisection setMedicationDuringSurgeries(List<IMedicationDuringSurgery> medicationDuringSurgeries){
...
<p>*/
@Override
	public VentralHemisection setTemporalIntervals(List<ITemporalInterval> temporalIntervals){
...
@Override
public String toString(){
return "VentralHemisection [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",animalCareConditions="+animalCareConditions+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",injuryAnaesthesiaAnaesthetics="+injuryAnaesthesiaAnaesthetics+",injuryArea="+injuryArea+",injuryDevice="+injuryDevice+",injuryIntensity="+injuryIntensity+",injuryPostsurgicalCareAnimalCareConditions="+injuryPostsurgicalCareAnimalCareConditions+",injuryVertebralLocation="+injuryVertebralLocation+",medicationDuringSurgeries="+medicationDuringSurgeries+",serialVersionUID="+serialVersionUID+",temporalIntervals="+temporalIntervals+",textMention="+textMention+"]";}
