...
@DirectInterface(get=IHeatLesion.class)
...
@DirectSiblings(get={CompleteTransection.class, Compression.class, Contusion.class, Laminectomy.class, ElectrolyticLesion.class, PhotochemicalInjury.class, Dislocation.class, InjuryByAccident.class, PartialTransection.class, Distraction.class, AspirationLesion.class, ChemicalInjury.class, HeatLesion.class, })
 public class HeatLesion implements IHeatLesion{

final public static IndividualFactory<HeatLesionIndividual> individualFactory = new IndividualFactory<>();
final public static Class<? extends AbstractIndividual> individualClassType = HeatLesionIndividual.class;
static class HeatLesionIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public HeatLesionIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "HeatLesionIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<HeatLesionIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final HeatLesionIndividual individual;
	@Override
	...
	@Override
	public HeatLesion setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/HeatLesion";
...
final private String textMention;
	...
	public HeatLesion(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
				HeatLesion.individualFactory.getIndividualByURI(individualURI);
...
this.textMention = null;
	...
	public HeatLesion(HeatLesion heatLesion)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
this.individual = heatLesion.individual;
this.investigationRestriction = heatLesion.investigationRestriction;
for (int j = 0; j < heatLesion.getAnimalCareConditions().size(); j++) {if (heatLesion.getAnimalCareConditions().get(j) != null) {animalCareConditions.add((IAnimalCareCondition) IOBIEThing.getCloneConstructor(heatLesion.getAnimalCareConditions().get(j).getClass()).newInstance(heatLesion.getAnimalCareConditions().get(j)));} else {animalCareConditions.add(null);}}
this.characterOffset = heatLesion.getCharacterOffset();
this.characterOnset = heatLesion.getCharacterOnset();
for (int j = 0; j < heatLesion.getInjuryAnaesthesiaAnaesthetics().size(); j++) {if (heatLesion.getInjuryAnaesthesiaAnaesthetics().get(j) != null) {injuryAnaesthesiaAnaesthetics.add((IAnaesthetic) IOBIEThing.getCloneConstructor(heatLesion.getInjuryAnaesthesiaAnaesthetics().get(j).getClass()).newInstance(heatLesion.getInjuryAnaesthesiaAnaesthetics().get(j)));} else {injuryAnaesthesiaAnaesthetics.add(null);}}
if(heatLesion.getInjuryArea()!=null)this.injuryArea = (IInjuryArea) IOBIEThing.getCloneConstructor(heatLesion.getInjuryArea().getClass())	.newInstance(heatLesion.getInjuryArea());
if(heatLesion.getInjuryDevice()!=null)this.injuryDevice = (IInjuryDevice) IOBIEThing.getCloneConstructor(heatLesion.getInjuryDevice().getClass())	.newInstance(heatLesion.getInjuryDevice());
if(heatLesion.getInjuryIntensity()!=null)this.injuryIntensity = (IInjuryIntensity) IOBIEThing.getCloneConstructor(heatLesion.getInjuryIntensity().getClass())	.newInstance(heatLesion.getInjuryIntensity());
for (int j = 0; j < heatLesion.getInjuryPostsurgicalCareAnimalCareConditions().size(); j++) {if (heatLesion.getInjuryPostsurgicalCareAnimalCareConditions().get(j) != null) {injuryPostsurgicalCareAnimalCareConditions.add((IAnimalCareCondition) IOBIEThing.getCloneConstructor(heatLesion.getInjuryPostsurgicalCareAnimalCareConditions().get(j).getClass()).newInstance(heatLesion.getInjuryPostsurgicalCareAnimalCareConditions().get(j)));} else {injuryPostsurgicalCareAnimalCareConditions.add(null);}}
if(heatLesion.getInjuryVertebralLocation()!=null)this.injuryVertebralLocation = (IVertebralLocation) IOBIEThing.getCloneConstructor(heatLesion.getInjuryVertebralLocation().getClass())	.newInstance(heatLesion.getInjuryVertebralLocation());
for (int j = 0; j < heatLesion.getMedicationDuringSurgeries().size(); j++) {if (heatLesion.getMedicationDuringSurgeries().get(j) != null) {medicationDuringSurgeries.add((IMedicationDuringSurgery) IOBIEThing.getCloneConstructor(heatLesion.getMedicationDuringSurgeries().get(j).getClass()).newInstance(heatLesion.getMedicationDuringSurgeries().get(j)));} else {medicationDuringSurgeries.add(null);}}
for (int j = 0; j < heatLesion.getTemporalIntervals().size(); j++) {if (heatLesion.getTemporalIntervals().get(j) != null) {temporalIntervals.add((ITemporalInterval) IOBIEThing.getCloneConstructor(heatLesion.getTemporalIntervals().get(j).getClass()).newInstance(heatLesion.getTemporalIntervals().get(j)));} else {temporalIntervals.add(null);}}
this.textMention = heatLesion.getTextMention();
}
...
<p>*/
@Override
	public HeatLesion addAnimalCareCondition(IAnimalCareCondition animalCareCondition){
...
<p>*/
@Override
	public HeatLesion addInjuryAnaesthesiaAnaesthetic(IAnaesthetic anaesthetic){
...
<p>*/
@Override
	public HeatLesion addInjuryPostsurgicalCareAnimalCareCondition(IAnimalCareCondition animalCareCondition){
...
<p>*/
@Override
	public HeatLesion addMedicationDuringSurgery(IMedicationDuringSurgery medicationDuringSurgery){
...
<p>*/
@Override
	public HeatLesion addTemporalInterval(ITemporalInterval temporalInterval){
...
return false;
HeatLesion other = (HeatLesion) obj;
if (individual == null) {
...
<p>*/
@Override
	public HeatLesion setAnimalCareConditions(List<IAnimalCareCondition> animalCareConditions){
...
<p>*/
@Override
	public HeatLesion setInjuryAnaesthesiaAnaesthetics(List<IAnaesthetic> anaesthetics){
...
<p>*/
@Override
	public HeatLesion setInjuryArea(IInjuryArea injuryArea){
...
<p>*/
@Override
	public HeatLesion setInjuryDevice(IInjuryDevice injuryDevice){
...
<p>*/
@Override
	public HeatLesion setInjuryIntensity(IInjuryIntensity injuryIntensity){
...
<p>*/
@Override
	public HeatLesion setInjuryPostsurgicalCareAnimalCareConditions(List<IAnimalCareCondition> animalCareConditions){
...
<p>*/
@Override
	public HeatLesion setInjuryVertebralLocation(IVertebralLocation vertebralLocation){
...
<p>*/
@Override
	public HeatLesion setMedicationDuringSurgeries(List<IMedicationDuringSurgery> medicationDuringSurgeries){
...
<p>*/
@Override
	public HeatLesion setTemporalIntervals(List<ITemporalInterval> temporalIntervals){
...
@Override
public String toString(){
return "HeatLesion [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",animalCareConditions="+animalCareConditions+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",injuryAnaesthesiaAnaesthetics="+injuryAnaesthesiaAnaesthetics+",injuryArea="+injuryArea+",injuryDevice="+injuryDevice+",injuryIntensity="+injuryIntensity+",injuryPostsurgicalCareAnimalCareConditions="+injuryPostsurgicalCareAnimalCareConditions+",injuryVertebralLocation="+injuryVertebralLocation+",medicationDuringSurgeries="+medicationDuringSurgeries+",serialVersionUID="+serialVersionUID+",temporalIntervals="+temporalIntervals+",textMention="+textMention+"]";}
