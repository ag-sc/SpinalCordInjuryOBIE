...
final public static Class<? extends AbstractIndividual> individualClassType = ProteinIndividual.class;
static class ProteinIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public ProteinIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "ProteinIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<ProteinIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final ProteinIndividual individual;
	@Override
...
<p>*/
@Override
	public Protein setCompoundSupplier(ICompoundSupplier compoundSupplier){
...
<p>*/
@Override
	public Protein setTissueSourceAnatomicalLocation(IAnatomicalLocation anatomicalLocation){
