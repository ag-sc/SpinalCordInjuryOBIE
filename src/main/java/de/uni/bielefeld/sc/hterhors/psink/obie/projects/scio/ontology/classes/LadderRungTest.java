...
static class LadderRungTestIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/LadderRungTest";
...
if(ladderRungTest.getDuration()!=null)this.duration = (IDuration) IOBIEThing.getCloneConstructor(ladderRungTest.getDuration().getClass())	.newInstance(ladderRungTest.getDuration());
...
this.textMention = null;
	...
	public LadderRungTest(String individualURI, String textMention){
this.individual = 
...
@Override
public String toString(){
return "LadderRungTest [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",duration="+duration+",makesUseOfApparatus="+makesUseOfApparatus+",serialVersionUID="+serialVersionUID+",testsForFunctions="+testsForFunctions+",textMention="+textMention+"]";}
