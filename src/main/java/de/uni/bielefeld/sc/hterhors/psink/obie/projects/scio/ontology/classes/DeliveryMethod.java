...
static class DeliveryMethodIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/DeliveryMethod";
...
if(deliveryMethod.getDuration()!=null)this.duration = (IDuration) IOBIEThing.getCloneConstructor(deliveryMethod.getDuration().getClass())	.newInstance(deliveryMethod.getDuration());
...
this.textMention = null;
	...
	public DeliveryMethod(String individualURI, String textMention){
this.individual = 
...
@Override
public String toString(){
return "DeliveryMethod [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",duration="+duration+",locations="+locations+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
