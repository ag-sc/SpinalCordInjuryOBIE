...
static class SurfaceRightingReflexTestIndividual extends AbstractIndividual {
	...
	@Override
	public SurfaceRightingReflexTest setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/SurfaceRightingReflexTest";
...
this.investigationRestriction = surfaceRightingReflexTest.investigationRestriction;
...
if(surfaceRightingReflexTest.getDuration()!=null)this.duration = new Duration((Duration)surfaceRightingReflexTest.getDuration());
...
this.textMention = surfaceRightingReflexTest.getTextMention();
	...
	public SurfaceRightingReflexTest(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
@Override
public String toString(){
return "SurfaceRightingReflexTest [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",duration="+duration+",makesUseOfApparatus="+makesUseOfApparatus+",serialVersionUID="+serialVersionUID+",testsForFunctions="+testsForFunctions+",textMention="+textMention+"]";}
