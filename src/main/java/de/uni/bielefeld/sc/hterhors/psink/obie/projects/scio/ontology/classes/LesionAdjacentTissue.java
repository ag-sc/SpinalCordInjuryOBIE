...
static class LesionAdjacentTissueIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/LesionAdjacentTissue";
...
final private String textMention;
	...
	public LesionAdjacentTissue(String individualURI, String textMention){
this.individual = 
...
if(lesionAdjacentTissue.getDepth()!=null)this.depth = (IDepth) IOBIEThing.getCloneConstructor(lesionAdjacentTissue.getDepth().getClass())	.newInstance(lesionAdjacentTissue.getDepth());
if(lesionAdjacentTissue.getDistance()!=null)this.distance = (IDistance) IOBIEThing.getCloneConstructor(lesionAdjacentTissue.getDistance().getClass())	.newInstance(lesionAdjacentTissue.getDistance());
...
@Override
public String toString(){
return "LesionAdjacentTissue [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",depth="+depth+",distance="+distance+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
