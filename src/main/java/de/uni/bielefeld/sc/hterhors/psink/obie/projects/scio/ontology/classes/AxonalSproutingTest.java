...
static class AxonalSproutingTestIndividual extends AbstractIndividual {
	...
	@Override
	public AxonalSproutingTest setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/AxonalSproutingTest";
...
this.investigationRestriction = axonalSproutingTest.investigationRestriction;
...
this.textMention = axonalSproutingTest.getTextMention();
	...
	public AxonalSproutingTest(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
@Override
public String toString(){
return "AxonalSproutingTest [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",locations="+locations+",makesUseOfApparatus="+makesUseOfApparatus+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
