...
static class MinipigSpeciesIndividual extends AbstractIndividual {
	...
	@Override
	public MinipigSpecies setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/MinipigSpecies";
...
final private String textMention;
	...
	public MinipigSpecies(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
this.investigationRestriction = minipigSpecies.investigationRestriction;
...
@Override
public String toString(){
return "MinipigSpecies [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
