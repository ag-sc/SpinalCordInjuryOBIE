...
<p>Dislocation is a displacement of a part of the spinal cord from its normal position.
<p>
*
* @author hterhors
*
...
final public static Class<? extends AbstractIndividual> individualClassType = DislocationIndividual.class;
static class DislocationIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public DislocationIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "DislocationIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<DislocationIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final DislocationIndividual individual;
	@Override
...
for (int j = 0; j < dislocation.getInjuryAnaesthesiaAnaesthetics().size(); j++) {if (dislocation.getInjuryAnaesthesiaAnaesthetics().get(j) != null) {injuryAnaesthesiaAnaesthetics.add((IAnaesthetic) IOBIEThing.getCloneConstructor(dislocation.getInjuryAnaesthesiaAnaesthetics().get(j).getClass()).newInstance(dislocation.getInjuryAnaesthesiaAnaesthetics().get(j)));} else {injuryAnaesthesiaAnaesthetics.add(null);}}
if(dislocation.getInjuryArea()!=null)this.injuryArea = (IInjuryArea) IOBIEThing.getCloneConstructor(dislocation.getInjuryArea().getClass())	.newInstance(dislocation.getInjuryArea());
if(dislocation.getInjuryDevice()!=null)this.injuryDevice = (IInjuryDevice) IOBIEThing.getCloneConstructor(dislocation.getInjuryDevice().getClass())	.newInstance(dislocation.getInjuryDevice());
if(dislocation.getInjuryIntensity()!=null)this.injuryIntensity = (IInjuryIntensity) IOBIEThing.getCloneConstructor(dislocation.getInjuryIntensity().getClass())	.newInstance(dislocation.getInjuryIntensity());
for (int j = 0; j < dislocation.getInjuryPostsurgicalCareAnimalCareConditions().size(); j++) {if (dislocation.getInjuryPostsurgicalCareAnimalCareConditions().get(j) != null) {injuryPostsurgicalCareAnimalCareConditions.add((IAnimalCareCondition) IOBIEThing.getCloneConstructor(dislocation.getInjuryPostsurgicalCareAnimalCareConditions().get(j).getClass()).newInstance(dislocation.getInjuryPostsurgicalCareAnimalCareConditions().get(j)));} else {injuryPostsurgicalCareAnimalCareConditions.add(null);}}
if(dislocation.getInjuryVertebralLocation()!=null)this.injuryVertebralLocation = (IVertebralLocation) IOBIEThing.getCloneConstructor(dislocation.getInjuryVertebralLocation().getClass())	.newInstance(dislocation.getInjuryVertebralLocation());
...
<p>*/
@Override
	public Dislocation addAnimalCareCondition(IAnimalCareCondition animalCareCondition){
...
<p>*/
@Override
	public Dislocation addInjuryAnaesthesiaAnaesthetic(IAnaesthetic anaesthetic){
...
<p>*/
@Override
	public Dislocation addInjuryPostsurgicalCareAnimalCareCondition(IAnimalCareCondition animalCareCondition){
...
<p>*/
@Override
	public Dislocation addMedicationDuringSurgery(IMedicationDuringSurgery medicationDuringSurgery){
...
<p>*/
@Override
	public Dislocation addTemporalInterval(ITemporalInterval temporalInterval){
...
return false;
Dislocation other = (Dislocation) obj;
if (individual == null) {
...
<p>*/
@Override
	public Dislocation setAnimalCareConditions(List<IAnimalCareCondition> animalCareConditions){
...
<p>*/
@Override
	public Dislocation setInjuryAnaesthesiaAnaesthetics(List<IAnaesthetic> anaesthetics){
...
<p>*/
@Override
	public Dislocation setInjuryArea(IInjuryArea injuryArea){
...
<p>*/
@Override
	public Dislocation setInjuryDevice(IInjuryDevice injuryDevice){
...
<p>*/
@Override
	public Dislocation setInjuryIntensity(IInjuryIntensity injuryIntensity){
...
<p>*/
@Override
	public Dislocation setInjuryPostsurgicalCareAnimalCareConditions(List<IAnimalCareCondition> animalCareConditions){
...
<p>*/
@Override
	public Dislocation setInjuryVertebralLocation(IVertebralLocation vertebralLocation){
...
<p>*/
@Override
	public Dislocation setMedicationDuringSurgeries(List<IMedicationDuringSurgery> medicationDuringSurgeries){
...
<p>*/
@Override
	public Dislocation setTemporalIntervals(List<ITemporalInterval> temporalIntervals){
