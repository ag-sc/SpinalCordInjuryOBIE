...
static class SpinalFiberTractIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/SpinalFiberTract";
...
final private String textMention;
	...
	public SpinalFiberTract(String individualURI, String textMention){
this.individual = 
...
if(spinalFiberTract.getDepth()!=null)this.depth = (IDepth) IOBIEThing.getCloneConstructor(spinalFiberTract.getDepth().getClass())	.newInstance(spinalFiberTract.getDepth());
if(spinalFiberTract.getDistance()!=null)this.distance = (IDistance) IOBIEThing.getCloneConstructor(spinalFiberTract.getDistance().getClass())	.newInstance(spinalFiberTract.getDistance());
...
@Override
public String toString(){
return "SpinalFiberTract [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",depth="+depth+",distance="+distance+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
