...
static class MortalityObservationIndividual extends AbstractIndividual {
	...
	@Override
	public MortalityObservation setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/MortalityObservation";
...
this.investigationRestriction = mortalityObservation.investigationRestriction;
...
this.textMention = mortalityObservation.getTextMention();
	...
	public MortalityObservation(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
@Override
public String toString(){
return "MortalityObservation [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",makesUseOfApparatus="+makesUseOfApparatus+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
