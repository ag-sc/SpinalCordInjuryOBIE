...
static class StemCellSourceTypeIndividual extends AbstractIndividual {
	...
	@Override
	public StemCellSourceType setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/StemCellSourceType";
...
final private String textMention;
	...
	public StemCellSourceType(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
this.investigationRestriction = stemCellSourceType.investigationRestriction;
...
@Override
public String toString(){
return "StemCellSourceType [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
