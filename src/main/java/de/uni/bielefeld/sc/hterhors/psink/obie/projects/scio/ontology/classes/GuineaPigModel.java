...
static class GuineaPigModelIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/GuineaPigModel";
...
if(guineaPigModel.getAge()!=null)this.age = (IAge) IOBIEThing.getCloneConstructor(guineaPigModel.getAge().getClass())	.newInstance(guineaPigModel.getAge());
...
if(guineaPigModel.getWeight()!=null)this.weight = (IWeight) IOBIEThing.getCloneConstructor(guineaPigModel.getWeight().getClass())	.newInstance(guineaPigModel.getWeight());
}
	public GuineaPigModel(String individualURI, String textMention){
this.individual = 
...
@Override
public String toString(){
return "GuineaPigModel [individual="+individual+",age="+age+",ageCategory="+ageCategory+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",gender="+gender+",organismSpecies="+organismSpecies+",serialVersionUID="+serialVersionUID+",textMention="+textMention+",weight="+weight+"]";}
