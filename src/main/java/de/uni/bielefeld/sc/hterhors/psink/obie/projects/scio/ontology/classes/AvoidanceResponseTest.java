...
static class AvoidanceResponseTestIndividual extends AbstractIndividual {
	...
	@Override
	public AvoidanceResponseTest setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/AvoidanceResponseTest";
...
this.textMention = null;
	...
	public AvoidanceResponseTest(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
this.investigationRestriction = avoidanceResponseTest.investigationRestriction;
this.characterOffset = avoidanceResponseTest.getCharacterOffset();
this.characterOnset = avoidanceResponseTest.getCharacterOnset();
if(avoidanceResponseTest.getDuration()!=null)this.duration = new Duration((Duration)avoidanceResponseTest.getDuration());
...
@Override
public String toString(){
return "AvoidanceResponseTest [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",duration="+duration+",makesUseOfApparatus="+makesUseOfApparatus+",serialVersionUID="+serialVersionUID+",testsForFunctions="+testsForFunctions+",textMention="+textMention+"]";}
