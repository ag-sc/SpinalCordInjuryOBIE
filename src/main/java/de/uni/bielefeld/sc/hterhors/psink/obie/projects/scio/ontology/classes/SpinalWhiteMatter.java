...
static class SpinalWhiteMatterIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/SpinalWhiteMatter";
...
if(spinalWhiteMatter.getDepth()!=null)this.depth = (IDepth) IOBIEThing.getCloneConstructor(spinalWhiteMatter.getDepth().getClass())	.newInstance(spinalWhiteMatter.getDepth());
if(spinalWhiteMatter.getDistance()!=null)this.distance = (IDistance) IOBIEThing.getCloneConstructor(spinalWhiteMatter.getDistance().getClass())	.newInstance(spinalWhiteMatter.getDistance());
this.textMention = spinalWhiteMatter.getTextMention();
}
	public SpinalWhiteMatter(String individualURI, String textMention){
this.individual = 
...
@Override
public String toString(){
return "SpinalWhiteMatter [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",depth="+depth+",distance="+distance+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
