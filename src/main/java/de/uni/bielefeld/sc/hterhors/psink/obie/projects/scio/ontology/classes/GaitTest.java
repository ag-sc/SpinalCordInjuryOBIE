...
static class GaitTestIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/GaitTest";
...
if(gaitTest.getDuration()!=null)this.duration = (IDuration) IOBIEThing.getCloneConstructor(gaitTest.getDuration().getClass())	.newInstance(gaitTest.getDuration());
...
this.textMention = gaitTest.getTextMention();
	...
	public GaitTest(String individualURI, String textMention){
this.individual = 
...
@Override
public String toString(){
return "GaitTest [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",duration="+duration+",makesUseOfApparatus="+makesUseOfApparatus+",serialVersionUID="+serialVersionUID+",testsForFunctions="+testsForFunctions+",textMention="+textMention+"]";}
