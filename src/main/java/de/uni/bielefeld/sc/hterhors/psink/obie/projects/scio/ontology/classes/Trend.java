...
static class TrendIndividual extends AbstractIndividual {
	...
	@Override
	public Trend setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/Trend";
...
this.investigationRestriction = trend.investigationRestriction;
...
this.textMention = trend.getTextMention();
	...
	public Trend(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
@Override
public String toString(){
return "Trend [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",observedDifference="+observedDifference+",serialVersionUID="+serialVersionUID+",significance="+significance+",textMention="+textMention+"]";}
