...
static class FluanisoneMidazolamMixtureIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/FluanisoneMidazolamMixture";
...
if(fluanisoneMidazolamMixture.getDosage()!=null)this.dosage = (IDosage) IOBIEThing.getCloneConstructor(fluanisoneMidazolamMixture.getDosage().getClass())	.newInstance(fluanisoneMidazolamMixture.getDosage());
this.textMention = fluanisoneMidazolamMixture.getTextMention();
}
	public FluanisoneMidazolamMixture(String individualURI, String textMention){
this.individual = 
...
@Override
public String toString(){
return "FluanisoneMidazolamMixture [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",deliveryMethod="+deliveryMethod+",dosage="+dosage+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
