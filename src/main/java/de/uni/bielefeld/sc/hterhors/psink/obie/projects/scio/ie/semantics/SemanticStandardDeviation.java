...
public class SemanticStandardDeviation extends AbstractNumericInterpreter {
	/**
	 * 
	 */
	...
	private SemanticStandardDeviation(String surfaceForm, double value) {
		super(surfaceForm);
		this.value = value;
	}

	public SemanticStandardDeviation normalize() {
		return this;
	}
	...
	public static class Builder extends AbstractInterpreterBuilder {
		...
		public SemanticStandardDeviation build() {
			return new SemanticStandardDeviation(surfaceForm, value);
		}

		public Builder interprete(final String surfaceForm) {
			Matcher matcher = SemanticStandardDeviation.PATTERN.matcher(surfaceForm);
			if (!matcher.find())
				return this;
		...
		public Builder fromMatcher(final Matcher matcher) {
			...
			if (matcher.group(SemanticStandardDeviation.pattern1GrouName) != null) {
				if (matcher.group(SemanticStandardDeviation.numGroup) != null)
					value = Double.valueOf(matcher.group(SemanticStandardDeviation.numGroup));
			}
			return this;
		}
	}
