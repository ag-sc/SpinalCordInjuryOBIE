...
static class SensoryTestIndividual extends AbstractIndividual {
	...
	@Override
	public SensoryTest setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/SensoryTest";
...
this.investigationRestriction = sensoryTest.investigationRestriction;
this.characterOffset = sensoryTest.getCharacterOffset();
this.characterOnset = sensoryTest.getCharacterOnset();
if(sensoryTest.getDuration()!=null)this.duration = new Duration((Duration)sensoryTest.getDuration());
...
this.textMention = sensoryTest.getTextMention();
	...
	public SensoryTest(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
@Override
public String toString(){
return "SensoryTest [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",duration="+duration+",makesUseOfApparatus="+makesUseOfApparatus+",serialVersionUID="+serialVersionUID+",testsForFunctions="+testsForFunctions+",textMention="+textMention+"]";}
