...
static class SurgeryTreatmentIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/SurgeryTreatment";
...
if(surgeryTreatment.getDuration()!=null)this.duration = (IDuration) IOBIEThing.getCloneConstructor(surgeryTreatment.getDuration().getClass())	.newInstance(surgeryTreatment.getDuration());
...
this.textMention = surgeryTreatment.getTextMention();
	...
	public SurgeryTreatment(String individualURI, String textMention){
this.individual = 
...
@Override
public String toString(){
return "SurgeryTreatment [individual="+individual+",applicationInstrument="+applicationInstrument+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",deliveryMethod="+deliveryMethod+",directions="+directions+",duration="+duration+",frequency="+frequency+",interval="+interval+",location="+location+",serialVersionUID="+serialVersionUID+",temporalIntervals="+temporalIntervals+",textMention="+textMention+"]";}
