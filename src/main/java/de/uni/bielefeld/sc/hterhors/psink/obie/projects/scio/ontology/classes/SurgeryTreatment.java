...
@DirectInterface(get=ISurgeryTreatment.class)
 public class SurgeryTreatment implements ISurgeryTreatment{

final public static IndividualFactory<SurgeryTreatmentIndividual> individualFactory = new IndividualFactory<>();
final public static Class<? extends AbstractIndividual> individualClassType = SurgeryTreatmentIndividual.class;
static class SurgeryTreatmentIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public SurgeryTreatmentIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "SurgeryTreatmentIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<SurgeryTreatmentIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final SurgeryTreatmentIndividual individual;
	@Override
	...
	@Override
	public SurgeryTreatment setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/SurgeryTreatment";
...
final private String textMention;
	...
	public SurgeryTreatment(SurgeryTreatment surgeryTreatment)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
this.individual = surgeryTreatment.individual;
this.investigationRestriction = surgeryTreatment.investigationRestriction;
if(surgeryTreatment.getApplicationInstrument()!=null)this.applicationInstrument = (IApplicationInstrument) IOBIEThing.getCloneConstructor(surgeryTreatment.getApplicationInstrument().getClass())	.newInstance(surgeryTreatment.getApplicationInstrument());
this.characterOffset = surgeryTreatment.getCharacterOffset();
this.characterOnset = surgeryTreatment.getCharacterOnset();
if(surgeryTreatment.getDeliveryMethod()!=null)this.deliveryMethod = (IDeliveryMethod) IOBIEThing.getCloneConstructor(surgeryTreatment.getDeliveryMethod().getClass())	.newInstance(surgeryTreatment.getDeliveryMethod());
for (int j = 0; j < surgeryTreatment.getDirections().size(); j++) {if (surgeryTreatment.getDirections().get(j) != null) {directions.add((IDirection) IOBIEThing.getCloneConstructor(surgeryTreatment.getDirections().get(j).getClass()).newInstance(surgeryTreatment.getDirections().get(j)));} else {directions.add(null);}}
if(surgeryTreatment.getDuration()!=null)this.duration = new Duration((Duration)surgeryTreatment.getDuration());
if(surgeryTreatment.getFrequency()!=null)this.frequency = new Frequency((Frequency)surgeryTreatment.getFrequency());
if(surgeryTreatment.getInterval()!=null)this.interval = new Interval((Interval)surgeryTreatment.getInterval());
if(surgeryTreatment.getLocation()!=null)this.location = (ILocation) IOBIEThing.getCloneConstructor(surgeryTreatment.getLocation().getClass())	.newInstance(surgeryTreatment.getLocation());
for (int j = 0; j < surgeryTreatment.getTemporalIntervals().size(); j++) {if (surgeryTreatment.getTemporalIntervals().get(j) != null) {temporalIntervals.add((ITemporalInterval) IOBIEThing.getCloneConstructor(surgeryTreatment.getTemporalIntervals().get(j).getClass()).newInstance(surgeryTreatment.getTemporalIntervals().get(j)));} else {temporalIntervals.add(null);}}
this.textMention = surgeryTreatment.getTextMention();
}
	public SurgeryTreatment(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
				SurgeryTreatment.individualFactory.getIndividualByURI(individualURI);
...
<p>*/
@Override
	public SurgeryTreatment addDirection(IDirection direction){
...
<p>*/
@Override
	public SurgeryTreatment addTemporalInterval(ITemporalInterval temporalInterval){
...
return false;
SurgeryTreatment other = (SurgeryTreatment) obj;
if (individual == null) {
...
<p>*/
@Override
	public SurgeryTreatment setApplicationInstrument(IApplicationInstrument applicationInstrument){
...
<p>*/
@Override
	public SurgeryTreatment setDeliveryMethod(IDeliveryMethod deliveryMethod){
...
<p>*/
@Override
	public SurgeryTreatment setDirections(List<IDirection> directions){
...
<p>*/
@Override
	public SurgeryTreatment setDuration(IDuration duration){
...
<p>*/
@Override
	public SurgeryTreatment setFrequency(IFrequency frequency){
...
<p>*/
@Override
	public SurgeryTreatment setInterval(IInterval interval){
...
<p>*/
@Override
	public SurgeryTreatment setLocation(ILocation location){
...
<p>*/
@Override
	public SurgeryTreatment setTemporalIntervals(List<ITemporalInterval> temporalIntervals){
...
@Override
public String toString(){
return "SurgeryTreatment [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",applicationInstrument="+applicationInstrument+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",deliveryMethod="+deliveryMethod+",directions="+directions+",duration="+duration+",frequency="+frequency+",interval="+interval+",location="+location+",serialVersionUID="+serialVersionUID+",temporalIntervals="+temporalIntervals+",textMention="+textMention+"]";}
