...
final public static Class<? extends AbstractIndividual> individualClassType = PioglitazoneIndividual.class;
static class PioglitazoneIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public PioglitazoneIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "PioglitazoneIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<PioglitazoneIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final PioglitazoneIndividual individual;
	@Override
...
return false;
Pioglitazone other = (Pioglitazone) obj;
if (individual == null) {
...
<p>*/
@Override
	public Pioglitazone setCompoundSupplier(ICompoundSupplier compoundSupplier){
...
<p>*/
@Override
	public Pioglitazone setTissueSourceAnatomicalLocation(IAnatomicalLocation anatomicalLocation){
