...
static class BodyTemperatureMeasurementIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/BodyTemperatureMeasurement";
...
this.textMention = bodyTemperatureMeasurement.getTextMention();
	...
	public BodyTemperatureMeasurement(String individualURI, String textMention){
this.individual = 
...
@Override
public String toString(){
return "BodyTemperatureMeasurement [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
