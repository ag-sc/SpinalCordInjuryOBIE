...
<p>http://ncicb.nci.nih.gov/xml/owl/EVS/Thesaurus.owl#C38216
<p>
<p><b>scio:descriptionSource</b>
<p>http://purl.bioontology.org/ontology/MESH/D000280
<p>
<p><b>rdfs:label</b>
<p>inhalation delivery
<p>
<p><b>rdfs:description</b>
<p>Inhalation delivery is the administration of drugs by the respiratory route. It includes insufflation into the respiratory tract.
<p>
*
* @author hterhors
*
...
final public static Class<? extends AbstractIndividual> individualClassType = InhalationDeliveryIndividual.class;
static class InhalationDeliveryIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public InhalationDeliveryIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "InhalationDeliveryIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<InhalationDeliveryIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final InhalationDeliveryIndividual individual;
	@Override
...
<p>*/
@Override
	public InhalationDelivery addLocation(ILocation location){
...
return false;
InhalationDelivery other = (InhalationDelivery) obj;
if (individual == null) {
...
<p>*/
@Override
	public InhalationDelivery setDuration(IDuration duration){
...
<p>*/
@Override
	public InhalationDelivery setLocations(List<ILocation> locations){
