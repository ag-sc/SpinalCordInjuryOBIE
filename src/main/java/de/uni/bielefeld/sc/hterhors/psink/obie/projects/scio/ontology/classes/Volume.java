...
@SuperRootClasses(get={Volume.class, })

@DirectSiblings(get={})

@DirectInterface(get=IVolume.class)
 public class Volume implements IVolume{

	final static public String ONTOLOGY_NAME = "http://psink.de/scio/Volume";
...
this.characterOffset = volume.getCharacterOffset();
this.characterOnset = volume.getCharacterOnset();
this.interpretedValue = volume.getInterpretedValue();
this.textMention = volume.getTextMention();
}
	public Volume(String interpretedValue, String textMention){
this.interpretedValue = interpretedValue;
this.textMention = textMention;
}
	public Volume(String interpretedValue){
this.interpretedValue = interpretedValue;
this.textMention = null;
}
...
return "Volume [characterOffset="+characterOffset+",characterOnset="+characterOnset+",interpretedValue="+interpretedValue+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
