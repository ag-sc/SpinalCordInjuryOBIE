...
<p>Partial Transection is a process causing spinal cord injury by cutting of the spinal cord, resulting in incomplete spinal cord injury which leaves a certain amount of the grey and/or white matter intact.
<p>
*
* @author hterhors
*
...
@AssignableSubClasses(get={VentralHemisection.class, DorsalHemisection.class, LateralHemisection.class, })
...
@DirectInterface(get=IPartialTransection.class)
 public class PartialTransection implements IPartialTransection{

final public static IndividualFactory<PartialTransectionIndividual> individualFactory = new IndividualFactory<>();
final public static Class<? extends AbstractIndividual> individualClassType = PartialTransectionIndividual.class;
static class PartialTransectionIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public PartialTransectionIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "PartialTransectionIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<PartialTransectionIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final PartialTransectionIndividual individual;
	@Override
	...
	@Override
	public PartialTransection setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/PartialTransection";
...
final private String textMention;
	...
	public PartialTransection(PartialTransection partialTransection)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
this.individual = partialTransection.individual;
this.investigationRestriction = partialTransection.investigationRestriction;
for (int j = 0; j < partialTransection.getAnimalCareConditions().size(); j++) {if (partialTransection.getAnimalCareConditions().get(j) != null) {animalCareConditions.add((IAnimalCareCondition) IOBIEThing.getCloneConstructor(partialTransection.getAnimalCareConditions().get(j).getClass()).newInstance(partialTransection.getAnimalCareConditions().get(j)));} else {animalCareConditions.add(null);}}
this.characterOffset = partialTransection.getCharacterOffset();
this.characterOnset = partialTransection.getCharacterOnset();
for (int j = 0; j < partialTransection.getInjuryAnaesthesiaAnaesthetics().size(); j++) {if (partialTransection.getInjuryAnaesthesiaAnaesthetics().get(j) != null) {injuryAnaesthesiaAnaesthetics.add((IAnaesthetic) IOBIEThing.getCloneConstructor(partialTransection.getInjuryAnaesthesiaAnaesthetics().get(j).getClass()).newInstance(partialTransection.getInjuryAnaesthesiaAnaesthetics().get(j)));} else {injuryAnaesthesiaAnaesthetics.add(null);}}
if(partialTransection.getInjuryArea()!=null)this.injuryArea = (IInjuryArea) IOBIEThing.getCloneConstructor(partialTransection.getInjuryArea().getClass())	.newInstance(partialTransection.getInjuryArea());
if(partialTransection.getInjuryDevice()!=null)this.injuryDevice = (IInjuryDevice) IOBIEThing.getCloneConstructor(partialTransection.getInjuryDevice().getClass())	.newInstance(partialTransection.getInjuryDevice());
if(partialTransection.getInjuryIntensity()!=null)this.injuryIntensity = (IInjuryIntensity) IOBIEThing.getCloneConstructor(partialTransection.getInjuryIntensity().getClass())	.newInstance(partialTransection.getInjuryIntensity());
for (int j = 0; j < partialTransection.getInjuryPostsurgicalCareAnimalCareConditions().size(); j++) {if (partialTransection.getInjuryPostsurgicalCareAnimalCareConditions().get(j) != null) {injuryPostsurgicalCareAnimalCareConditions.add((IAnimalCareCondition) IOBIEThing.getCloneConstructor(partialTransection.getInjuryPostsurgicalCareAnimalCareConditions().get(j).getClass()).newInstance(partialTransection.getInjuryPostsurgicalCareAnimalCareConditions().get(j)));} else {injuryPostsurgicalCareAnimalCareConditions.add(null);}}
if(partialTransection.getInjuryVertebralLocation()!=null)this.injuryVertebralLocation = (IVertebralLocation) IOBIEThing.getCloneConstructor(partialTransection.getInjuryVertebralLocation().getClass())	.newInstance(partialTransection.getInjuryVertebralLocation());
for (int j = 0; j < partialTransection.getMedicationDuringSurgeries().size(); j++) {if (partialTransection.getMedicationDuringSurgeries().get(j) != null) {medicationDuringSurgeries.add((IMedicationDuringSurgery) IOBIEThing.getCloneConstructor(partialTransection.getMedicationDuringSurgeries().get(j).getClass()).newInstance(partialTransection.getMedicationDuringSurgeries().get(j)));} else {medicationDuringSurgeries.add(null);}}
for (int j = 0; j < partialTransection.getTemporalIntervals().size(); j++) {if (partialTransection.getTemporalIntervals().get(j) != null) {temporalIntervals.add((ITemporalInterval) IOBIEThing.getCloneConstructor(partialTransection.getTemporalIntervals().get(j).getClass()).newInstance(partialTransection.getTemporalIntervals().get(j)));} else {temporalIntervals.add(null);}}
this.textMention = partialTransection.getTextMention();
}
	public PartialTransection(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
				PartialTransection.individualFactory.getIndividualByURI(individualURI);
this.investigationRestriction = investigationRestriction==null?InvestigationRestriction.noRestrictionInstance:investigationRestriction;
this.textMention = textMention;
}
	public PartialTransection(){
...
<p>*/
@Override
	public PartialTransection addAnimalCareCondition(IAnimalCareCondition animalCareCondition){
...
<p>*/
@Override
	public PartialTransection addInjuryAnaesthesiaAnaesthetic(IAnaesthetic anaesthetic){
...
<p>*/
@Override
	public PartialTransection addInjuryPostsurgicalCareAnimalCareCondition(IAnimalCareCondition animalCareCondition){
...
<p>*/
@Override
	public PartialTransection addMedicationDuringSurgery(IMedicationDuringSurgery medicationDuringSurgery){
...
<p>*/
@Override
	public PartialTransection addTemporalInterval(ITemporalInterval temporalInterval){
...
return false;
PartialTransection other = (PartialTransection) obj;
if (individual == null) {
...
<p>*/
@Override
	public PartialTransection setAnimalCareConditions(List<IAnimalCareCondition> animalCareConditions){
...
<p>*/
@Override
	public PartialTransection setInjuryAnaesthesiaAnaesthetics(List<IAnaesthetic> anaesthetics){
...
<p>*/
@Override
	public PartialTransection setInjuryArea(IInjuryArea injuryArea){
...
<p>*/
@Override
	public PartialTransection setInjuryDevice(IInjuryDevice injuryDevice){
...
<p>*/
@Override
	public PartialTransection setInjuryIntensity(IInjuryIntensity injuryIntensity){
...
<p>*/
@Override
	public PartialTransection setInjuryPostsurgicalCareAnimalCareConditions(List<IAnimalCareCondition> animalCareConditions){
...
<p>*/
@Override
	public PartialTransection setInjuryVertebralLocation(IVertebralLocation vertebralLocation){
...
<p>*/
@Override
	public PartialTransection setMedicationDuringSurgeries(List<IMedicationDuringSurgery> medicationDuringSurgeries){
...
<p>*/
@Override
	public PartialTransection setTemporalIntervals(List<ITemporalInterval> temporalIntervals){
...
@Override
public String toString(){
return "PartialTransection [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",animalCareConditions="+animalCareConditions+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",injuryAnaesthesiaAnaesthetics="+injuryAnaesthesiaAnaesthetics+",injuryArea="+injuryArea+",injuryDevice="+injuryDevice+",injuryIntensity="+injuryIntensity+",injuryPostsurgicalCareAnimalCareConditions="+injuryPostsurgicalCareAnimalCareConditions+",injuryVertebralLocation="+injuryVertebralLocation+",medicationDuringSurgeries="+medicationDuringSurgeries+",serialVersionUID="+serialVersionUID+",temporalIntervals="+temporalIntervals+",textMention="+textMention+"]";}
