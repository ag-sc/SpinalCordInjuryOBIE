...
static class CorticospinalTractIndividual extends AbstractIndividual {
	...
	@Override
	public CorticospinalTract setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/CorticospinalTract";
...
this.investigationRestriction = corticospinalTract.investigationRestriction;
this.characterOffset = corticospinalTract.getCharacterOffset();
this.characterOnset = corticospinalTract.getCharacterOnset();
if(corticospinalTract.getDepth()!=null)this.depth = new Depth((Depth)corticospinalTract.getDepth());
if(corticospinalTract.getDistance()!=null)this.distance = new Distance((Distance)corticospinalTract.getDistance());
...
this.textMention = null;
	...
	public CorticospinalTract(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
@Override
public String toString(){
return "CorticospinalTract [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",depth="+depth+",distance="+distance+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
