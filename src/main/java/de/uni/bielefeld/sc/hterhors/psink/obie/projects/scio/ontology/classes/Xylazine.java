...
static class XylazineIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/Xylazine";
...
this.textMention = null;
	...
	public Xylazine(String individualURI, String textMention){
this.individual = 
...
if(xylazine.getDosage()!=null)this.dosage = (IDosage) IOBIEThing.getCloneConstructor(xylazine.getDosage().getClass())	.newInstance(xylazine.getDosage());
...
@Override
public String toString(){
return "Xylazine [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",deliveryMethod="+deliveryMethod+",dosage="+dosage+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
