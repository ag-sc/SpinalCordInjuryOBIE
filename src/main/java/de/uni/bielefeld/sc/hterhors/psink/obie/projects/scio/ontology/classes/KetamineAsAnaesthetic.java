...
static class KetamineAsAnaestheticIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/KetamineAsAnaesthetic";
...
if(ketamineAsAnaesthetic.getDosage()!=null)this.dosage = (IDosage) IOBIEThing.getCloneConstructor(ketamineAsAnaesthetic.getDosage().getClass())	.newInstance(ketamineAsAnaesthetic.getDosage());
this.textMention = ketamineAsAnaesthetic.getTextMention();
}
	public KetamineAsAnaesthetic(String individualURI, String textMention){
this.individual = 
...
@Override
public String toString(){
return "KetamineAsAnaesthetic [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",deliveryMethod="+deliveryMethod+",dosage="+dosage+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
