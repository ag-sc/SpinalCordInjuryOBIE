...
static class PositiveSignificanceIndividual extends AbstractIndividual {
	...
	@Override
	public PositiveSignificance setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/PositiveSignificance";
	@DatatypeProperty
...
this.investigationRestriction = positiveSignificance.investigationRestriction;
...
this.textMention = null;
	...
	public PositiveSignificance(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
@Override
public String toString(){
return "PositiveSignificance [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",alphaSignificanceNiveau="+alphaSignificanceNiveau+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",pValue="+pValue+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
