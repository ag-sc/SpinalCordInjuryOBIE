...
@SuperRootClasses(get={Pressure.class, })
...
@DirectInterface(get=IPressure.class)
 public class Pressure implements IPressure{

	final static public String ONTOLOGY_NAME = "http://psink.de/scio/Pressure";
...
this.characterOffset = pressure.getCharacterOffset();
this.characterOnset = pressure.getCharacterOnset();
this.interpretedValue = pressure.getInterpretedValue();
this.textMention = pressure.getTextMention();
}
	public Pressure(){
this.interpretedValue = null;
this.textMention = null;
}
	public Pressure(String interpretedValue, String textMention){
this.interpretedValue = interpretedValue;
this.textMention = textMention;
}
	public Pressure(String interpretedValue){
this.interpretedValue = interpretedValue;
this.textMention = null;
}
...
return "Pressure [characterOffset="+characterOffset+",characterOnset="+characterOnset+",interpretedValue="+interpretedValue+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
