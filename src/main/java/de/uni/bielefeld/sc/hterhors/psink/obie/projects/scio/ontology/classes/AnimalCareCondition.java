...
static class AnimalCareConditionIndividual extends AbstractIndividual {
	...
	@Override
	public AnimalCareCondition setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/AnimalCareCondition";
...
this.textMention = null;
	...
	public AnimalCareCondition(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
this.investigationRestriction = animalCareCondition.investigationRestriction;
...
@Override
public String toString(){
return "AnimalCareCondition [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
