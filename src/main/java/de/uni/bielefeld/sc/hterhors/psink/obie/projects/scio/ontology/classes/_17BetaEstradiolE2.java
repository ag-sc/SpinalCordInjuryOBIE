 ...
 * <p>
 * https://www.ncbi.nlm.nih.gov/mesh/68004958
 * <p>
 * <p>
 * <b>rdfs:label</b>
 * <p>
 ...
 * <p>
 * 17Beta Estradiol E 2 is the 17-beta-isomer of estradiol, an aromatized C18
 * steroid with hydroxyl group at 3-beta- and 17-beta-position.
...
@DirectSiblings(get = { Steroid.class, Melatonin.class, P4.class, Erythropoietin.class,
		DehydroEpiandrosteroneSulfate.class, Estrogen.class, _17BetaEstradiolE2.class, PregnenoloneS.class,
		Pregnenolone.class, RecombinantEPORhEpo.class, AsialoEPO.class, EstradiolBenzoate.class, Progesterone.class, })
...
public class _17BetaEstradiolE2 implements I_17BetaEstradiolE2 {
	...
	static class _17BetaEstradiolE2Individual extends AbstractIndividual {
		...
		public _17BetaEstradiolE2Individual(String namespace, String name) {
	...
	final static public String ONTOLOGY_NAME = "http://psink.de/scio/17BetaEstradiolE2";
	...
	public _17BetaEstradiolE2(String individualURI, String textMention) {
		this.individual = _17BetaEstradiolE2.individualFactory.getIndividualByURI(individualURI);
	...
	public _17BetaEstradiolE2(_17BetaEstradiolE2 _17BetaEstradiolE2)
		...
		if (_17BetaEstradiolE2.getCompoundSupplier() != null)
			this.compoundSupplier = (ICompoundSupplier) IOBIEThing
					.getCloneConstructor(_17BetaEstradiolE2.getCompoundSupplier().getClass())
					.newInstance(_17BetaEstradiolE2.getCompoundSupplier());
		this.textMention = _17BetaEstradiolE2.getTextMention();
		if (_17BetaEstradiolE2.getTissueSourceAnatomicalLocation() != null)
			this.tissueSourceAnatomicalLocation = (IAnatomicalLocation) IOBIEThing
					.getCloneConstructor(_17BetaEstradiolE2.getTissueSourceAnatomicalLocation().getClass())
					.newInstance(_17BetaEstradiolE2.getTissueSourceAnatomicalLocation());
	}
	 ...
	 * <b>scio:example</b>
	 * <p>
	 * All compunds were provided by Dragon Pharmaceuticals.
	 * <p>
	 * <p>
	 * <b>rdfs:label</b>
	 * <p>
	 ...
	 * <b>rdfs:comment</b>
	 * <p>
	 * Property of the compound, e.g. the substance applied. It points at the
	 * supplier, e.g. a pharmacological company.
	 * <p>
	 */
	@Override
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((this.tissueSourceAnatomicalLocation == null) ? 0 : this.tissueSourceAnatomicalLocation.hashCode());
	...
	@Override
	public String toString() {
		return "_17BetaEstradiolE2 [individual=" + individual + ",characterOffset=" + characterOffset
				+ ",characterOnset=" + characterOnset + ",compoundSupplier=" + compoundSupplier + ",serialVersionUID="
				+ serialVersionUID + ",textMention=" + textMention + ",tissueSourceAnatomicalLocation="
