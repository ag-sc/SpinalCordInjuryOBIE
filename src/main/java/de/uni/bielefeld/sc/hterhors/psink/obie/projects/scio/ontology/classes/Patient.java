...
static class PatientIndividual extends AbstractIndividual {
	...
	@Override
	public Patient setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/Patient";
	@DatatypeProperty
...
private IWeight weight;
	...
	public Patient(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
this.investigationRestriction = patient.investigationRestriction;
if(patient.getAge()!=null)this.age = new Age((Age)patient.getAge());
...
if(patient.getWeight()!=null)this.weight = new Weight((Weight)patient.getWeight());
}
	public Patient(){
