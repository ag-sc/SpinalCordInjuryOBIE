...
static class IsofluraneIndividual extends AbstractIndividual {
	...
	@Override
	public Isoflurane setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/Isoflurane";
...
this.investigationRestriction = isoflurane.investigationRestriction;
...
if(isoflurane.getDosage()!=null)this.dosage = new Dosage((Dosage)isoflurane.getDosage());
this.textMention = isoflurane.getTextMention();
}
	public Isoflurane(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
@Override
public String toString(){
return "Isoflurane [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",deliveryMethod="+deliveryMethod+",dosage="+dosage+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
