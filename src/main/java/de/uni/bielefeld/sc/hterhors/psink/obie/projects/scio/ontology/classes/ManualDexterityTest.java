...
static class ManualDexterityTestIndividual extends AbstractIndividual {
	...
	@Override
	public ManualDexterityTest setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/ManualDexterityTest";
...
this.textMention = null;
	...
	public ManualDexterityTest(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
this.investigationRestriction = manualDexterityTest.investigationRestriction;
this.characterOffset = manualDexterityTest.getCharacterOffset();
this.characterOnset = manualDexterityTest.getCharacterOnset();
if(manualDexterityTest.getDuration()!=null)this.duration = new Duration((Duration)manualDexterityTest.getDuration());
...
@Override
public String toString(){
return "ManualDexterityTest [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",duration="+duration+",makesUseOfApparatus="+makesUseOfApparatus+",serialVersionUID="+serialVersionUID+",testsForFunctions="+testsForFunctions+",textMention="+textMention+"]";}
