...
static class SurvivalObservationIndividual extends AbstractIndividual {
	...
	@Override
	public SurvivalObservation setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/SurvivalObservation";
...
final private String textMention;
	...
	public SurvivalObservation(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
this.investigationRestriction = survivalObservation.investigationRestriction;
...
@Override
public String toString(){
return "SurvivalObservation [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",makesUseOfApparatus="+makesUseOfApparatus+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
