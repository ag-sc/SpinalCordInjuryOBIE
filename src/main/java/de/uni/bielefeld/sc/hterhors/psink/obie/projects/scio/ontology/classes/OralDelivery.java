...
static class OralDeliveryIndividual extends AbstractIndividual {
	...
	@Override
	public OralDelivery setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/OralDelivery";
...
final private String textMention;
	...
	public OralDelivery(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
this.investigationRestriction = oralDelivery.investigationRestriction;
this.characterOffset = oralDelivery.getCharacterOffset();
this.characterOnset = oralDelivery.getCharacterOnset();
if(oralDelivery.getDuration()!=null)this.duration = new Duration((Duration)oralDelivery.getDuration());
...
@Override
public String toString(){
return "OralDelivery [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",duration="+duration+",locations="+locations+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
