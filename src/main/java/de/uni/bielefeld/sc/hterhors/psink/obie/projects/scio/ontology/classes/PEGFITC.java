...
@DirectInterface(get=IPEGFITC.class)
 public class PEGFITC implements IPEGFITC{

final public static IndividualFactory<PEGFITCIndividual> individualFactory = new IndividualFactory<>();
final public static Class<? extends AbstractIndividual> individualClassType = PEGFITCIndividual.class;
static class PEGFITCIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public PEGFITCIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "PEGFITCIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<PEGFITCIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final PEGFITCIndividual individual;
	@Override
	...
	@Override
	public PEGFITC setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/PEGFITC";
...
private IAnatomicalLocation tissueSourceAnatomicalLocation;
	...
	public PEGFITC(PEGFITC pEGFITC)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
this.individual = pEGFITC.individual;
this.investigationRestriction = pEGFITC.investigationRestriction;
this.characterOffset = pEGFITC.getCharacterOffset();
this.characterOnset = pEGFITC.getCharacterOnset();
if(pEGFITC.getCompoundSupplier()!=null)this.compoundSupplier = (ICompoundSupplier) IOBIEThing.getCloneConstructor(pEGFITC.getCompoundSupplier().getClass())	.newInstance(pEGFITC.getCompoundSupplier());
this.textMention = pEGFITC.getTextMention();
if(pEGFITC.getTissueSourceAnatomicalLocation()!=null)this.tissueSourceAnatomicalLocation = (IAnatomicalLocation) IOBIEThing.getCloneConstructor(pEGFITC.getTissueSourceAnatomicalLocation().getClass())	.newInstance(pEGFITC.getTissueSourceAnatomicalLocation());
}
	public PEGFITC(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
				PEGFITC.individualFactory.getIndividualByURI(individualURI);
...
<p>*/
@Override
	public PEGFITC setCompoundSupplier(ICompoundSupplier compoundSupplier){
...
<p>*/
@Override
	public PEGFITC setTissueSourceAnatomicalLocation(IAnatomicalLocation anatomicalLocation){
...
@Override
public String toString(){
return "PEGFITC [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",compoundSupplier="+compoundSupplier+",serialVersionUID="+serialVersionUID+",textMention="+textMention+",tissueSourceAnatomicalLocation="+tissueSourceAnatomicalLocation+"]";}
