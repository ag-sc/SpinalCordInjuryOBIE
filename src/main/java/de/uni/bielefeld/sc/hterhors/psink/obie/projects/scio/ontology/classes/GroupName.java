...
this.semanticValue = groupName.getSemanticValue();
...
this.textMention = null;
	...
	public GroupName(String semanticValue, String textMention){
this.semanticValue = semanticValue;
this.textMention = textMention;
}
	public GroupName(String semanticValue){
this.semanticValue = semanticValue;
this.textMention = null;
}
...
return "GroupName [characterOffset="+characterOffset+",characterOnset="+characterOnset+",semanticValue="+semanticValue+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
