...
@DirectInterface(get=IMotorReflexTest.class)

@SuperRootClasses(get={InvestigationMethod.class, })

@AssignableSubClasses(get={ContactPlacingResponseTest.class, SurfaceRightingReflexTest.class, })
 public class MotorReflexTest implements IMotorReflexTest{

final public static IndividualFactory<MotorReflexTestIndividual> individualFactory = new IndividualFactory<>();
final public static Class<? extends AbstractIndividual> individualClassType = MotorReflexTestIndividual.class;
static class MotorReflexTestIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public MotorReflexTestIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "MotorReflexTestIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<MotorReflexTestIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final MotorReflexTestIndividual individual;
	@Override
...
<p>*/
@Override
	public MotorReflexTest addMakesUseOfApparatus(IApparatus apparatus){
...
<p>*/
@Override
	public MotorReflexTest addTestsForFunction(IFunction function){
...
return false;
MotorReflexTest other = (MotorReflexTest) obj;
if (individual == null) {
...
<p>*/
@Override
	public MotorReflexTest setDuration(IDuration duration){
...
<p>*/
@Override
	public MotorReflexTest setMakesUseOfApparatus(List<IApparatus> apparatus){
...
<p>*/
@Override
	public MotorReflexTest setTestsForFunctions(List<IFunction> functions){
