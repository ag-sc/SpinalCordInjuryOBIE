...
static class ModificationTreatmentIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/ModificationTreatment";
...
this.textMention = null;
	...
	public ModificationTreatment(String individualURI, String textMention){
this.individual = 
...
if(modificationTreatment.getDuration()!=null)this.duration = (IDuration) IOBIEThing.getCloneConstructor(modificationTreatment.getDuration().getClass())	.newInstance(modificationTreatment.getDuration());
...
@Override
public String toString(){
return "ModificationTreatment [individual="+individual+",applicationInstrument="+applicationInstrument+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",deliveryMethod="+deliveryMethod+",directions="+directions+",duration="+duration+",frequency="+frequency+",interval="+interval+",location="+location+",serialVersionUID="+serialVersionUID+",temporalIntervals="+temporalIntervals+",textMention="+textMention+"]";}
