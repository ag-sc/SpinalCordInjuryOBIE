...
@AssignableSubClasses(get={MesenchymalStemCell.class, UmbilicalCordBloodStemCell.class, BoneMarrowStemCell.class, })

@SuperRootClasses(get={Compound.class, })

@DirectInterface(get=IStemCell.class)

@DirectSiblings(get={GlialCell.class, StemCell.class, ImmuneCell.class, })
 public class StemCell implements IStemCell{

final public static IndividualFactory<StemCellIndividual> individualFactory = new IndividualFactory<>();
final public static Class<? extends AbstractIndividual> individualClassType = StemCellIndividual.class;
static class StemCellIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public StemCellIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "StemCellIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<StemCellIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final StemCellIndividual individual;
	@Override
	...
	@Override
	public StemCell setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/StemCell";
...
private IAnatomicalLocation tissueSourceAnatomicalLocation;
	...
	public StemCell(StemCell stemCell)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
this.individual = stemCell.individual;
this.investigationRestriction = stemCell.investigationRestriction;
this.characterOffset = stemCell.getCharacterOffset();
this.characterOnset = stemCell.getCharacterOnset();
if(stemCell.getCompoundBiologicalRelation()!=null)this.compoundBiologicalRelation = (ICompoundBiologicalRelation) IOBIEThing.getCloneConstructor(stemCell.getCompoundBiologicalRelation().getClass())	.newInstance(stemCell.getCompoundBiologicalRelation());
if(stemCell.getCompoundSupplier()!=null)this.compoundSupplier = (ICompoundSupplier) IOBIEThing.getCloneConstructor(stemCell.getCompoundSupplier().getClass())	.newInstance(stemCell.getCompoundSupplier());
for (int j = 0; j < stemCell.getExperimentalProcedures().size(); j++) {if (stemCell.getExperimentalProcedures().get(j) != null) {experimentalProcedures.add((IExperimentalProcedure) IOBIEThing.getCloneConstructor(stemCell.getExperimentalProcedures().get(j).getClass()).newInstance(stemCell.getExperimentalProcedures().get(j)));} else {experimentalProcedures.add(null);}}
if(stemCell.getOrganismSpecies()!=null)this.organismSpecies = (IOrganismSpecies) IOBIEThing.getCloneConstructor(stemCell.getOrganismSpecies().getClass())	.newInstance(stemCell.getOrganismSpecies());
if(stemCell.getStemCellSourceType()!=null)this.stemCellSourceType = (IStemCellSourceType) IOBIEThing.getCloneConstructor(stemCell.getStemCellSourceType().getClass())	.newInstance(stemCell.getStemCellSourceType());
this.textMention = stemCell.getTextMention();
if(stemCell.getTissueSourceAnatomicalLocation()!=null)this.tissueSourceAnatomicalLocation = (IAnatomicalLocation) IOBIEThing.getCloneConstructor(stemCell.getTissueSourceAnatomicalLocation().getClass())	.newInstance(stemCell.getTissueSourceAnatomicalLocation());
}
	public StemCell(){
...
this.textMention = null;
	...
	public StemCell(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
				StemCell.individualFactory.getIndividualByURI(individualURI);
...
<p>*/
@Override
	public StemCell addExperimentalProcedure(IExperimentalProcedure experimentalProcedure){
...
<p>*/
@Override
	public StemCell setCompoundBiologicalRelation(ICompoundBiologicalRelation compoundBiologicalRelation){
...
<p>*/
@Override
	public StemCell setCompoundSupplier(ICompoundSupplier compoundSupplier){
...
<p>*/
@Override
	public StemCell setExperimentalProcedures(List<IExperimentalProcedure> experimentalProcedures){
...
<p>*/
@Override
	public StemCell setOrganismSpecies(IOrganismSpecies organismSpecies){
...
<p>*/
@Override
	public StemCell setStemCellSourceType(IStemCellSourceType stemCellSourceType){
...
<p>*/
@Override
	public StemCell setTissueSourceAnatomicalLocation(IAnatomicalLocation anatomicalLocation){
