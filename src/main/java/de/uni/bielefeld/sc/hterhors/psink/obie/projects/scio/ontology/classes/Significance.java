...
static class SignificanceIndividual extends AbstractIndividual {
	...
	@Override
	public Significance setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/Significance";
	@DatatypeProperty
...
final private String textMention;
	...
	public Significance(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
this.investigationRestriction = significance.investigationRestriction;
...
@Override
public String toString(){
return "Significance [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",alphaSignificanceNiveau="+alphaSignificanceNiveau+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",pValue="+pValue+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
