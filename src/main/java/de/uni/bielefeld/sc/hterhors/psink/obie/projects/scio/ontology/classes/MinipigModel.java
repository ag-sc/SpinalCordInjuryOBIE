...
static class MinipigModelIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/MinipigModel";
...
this.textMention = null;
	...
	public MinipigModel(String individualURI, String textMention){
this.individual = 
...
if(minipigModel.getAge()!=null)this.age = (IAge) IOBIEThing.getCloneConstructor(minipigModel.getAge().getClass())	.newInstance(minipigModel.getAge());
...
if(minipigModel.getWeight()!=null)this.weight = (IWeight) IOBIEThing.getCloneConstructor(minipigModel.getWeight().getClass())	.newInstance(minipigModel.getWeight());
}
...
@Override
public String toString(){
return "MinipigModel [individual="+individual+",age="+age+",ageCategory="+ageCategory+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",gender="+gender+",organismSpecies="+organismSpecies+",serialVersionUID="+serialVersionUID+",textMention="+textMention+",weight="+weight+"]";}
