...
final public static Class<? extends AbstractIndividual> individualClassType = AntiNogoAAntibodyIndividual.class;
static class AntiNogoAAntibodyIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public AntiNogoAAntibodyIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "AntiNogoAAntibodyIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<AntiNogoAAntibodyIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final AntiNogoAAntibodyIndividual individual;
	@Override
...
return false;
AntiNogoAAntibody other = (AntiNogoAAntibody) obj;
if (individual == null) {
...
<p>*/
@Override
	public AntiNogoAAntibody setCompoundSupplier(ICompoundSupplier compoundSupplier){
...
<p>*/
@Override
	public AntiNogoAAntibody setTissueSourceAnatomicalLocation(IAnatomicalLocation anatomicalLocation){
