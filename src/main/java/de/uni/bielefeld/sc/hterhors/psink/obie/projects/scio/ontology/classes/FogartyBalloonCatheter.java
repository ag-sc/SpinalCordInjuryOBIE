...
static class FogartyBalloonCatheterIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/FogartyBalloonCatheter";
...
if(fogartyBalloonCatheter.getForce()!=null)this.force = (IForce) IOBIEThing.getCloneConstructor(fogartyBalloonCatheter.getForce().getClass())	.newInstance(fogartyBalloonCatheter.getForce());
if(fogartyBalloonCatheter.getPressure()!=null)this.pressure = (IPressure) IOBIEThing.getCloneConstructor(fogartyBalloonCatheter.getPressure().getClass())	.newInstance(fogartyBalloonCatheter.getPressure());
this.textMention = fogartyBalloonCatheter.getTextMention();
if(fogartyBalloonCatheter.getVolume()!=null)this.volume = (IVolume) IOBIEThing.getCloneConstructor(fogartyBalloonCatheter.getVolume().getClass())	.newInstance(fogartyBalloonCatheter.getVolume());
}
	public FogartyBalloonCatheter(String individualURI, String textMention){
this.individual = 
...
@Override
public String toString(){
return "FogartyBalloonCatheter [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",force="+force+",pressure="+pressure+",serialVersionUID="+serialVersionUID+",textMention="+textMention+",volume="+volume+"]";}
