...
static class BloodCirculationExaminationIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/BloodCirculationExamination";
...
final private String textMention;
	...
	public BloodCirculationExamination(String individualURI, String textMention){
this.individual = 
...
if(bloodCirculationExamination.getDuration()!=null)this.duration = (IDuration) IOBIEThing.getCloneConstructor(bloodCirculationExamination.getDuration().getClass())	.newInstance(bloodCirculationExamination.getDuration());
...
@Override
public String toString(){
return "BloodCirculationExamination [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",duration="+duration+",makesUseOfApparatus="+makesUseOfApparatus+",serialVersionUID="+serialVersionUID+",testsForFunctions="+testsForFunctions+",textMention="+textMention+"]";}
