...
static class SpinalCordIndividual extends AbstractIndividual {
	...
	@Override
	public SpinalCord setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/SpinalCord";
...
final private String textMention;
	...
	public SpinalCord(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
this.investigationRestriction = spinalCord.investigationRestriction;
this.characterOffset = spinalCord.getCharacterOffset();
this.characterOnset = spinalCord.getCharacterOnset();
if(spinalCord.getDepth()!=null)this.depth = new Depth((Depth)spinalCord.getDepth());
if(spinalCord.getDistance()!=null)this.distance = new Distance((Distance)spinalCord.getDistance());
...
@Override
public String toString(){
return "SpinalCord [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",depth="+depth+",distance="+distance+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
