...
static class NitrousOxideIndividual extends AbstractIndividual {
	...
	@Override
	public NitrousOxide setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/NitrousOxide";
...
this.investigationRestriction = nitrousOxide.investigationRestriction;
...
if(nitrousOxide.getDosage()!=null)this.dosage = new Dosage((Dosage)nitrousOxide.getDosage());
this.textMention = nitrousOxide.getTextMention();
}
	public NitrousOxide(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
@Override
public String toString(){
return "NitrousOxide [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",deliveryMethod="+deliveryMethod+",dosage="+dosage+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
