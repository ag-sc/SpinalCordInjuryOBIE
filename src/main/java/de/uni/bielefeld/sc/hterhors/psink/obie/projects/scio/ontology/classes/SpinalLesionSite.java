...
static class SpinalLesionSiteIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/SpinalLesionSite";
...
if(spinalLesionSite.getDepth()!=null)this.depth = (IDepth) IOBIEThing.getCloneConstructor(spinalLesionSite.getDepth().getClass())	.newInstance(spinalLesionSite.getDepth());
if(spinalLesionSite.getDistance()!=null)this.distance = (IDistance) IOBIEThing.getCloneConstructor(spinalLesionSite.getDistance().getClass())	.newInstance(spinalLesionSite.getDistance());
this.textMention = spinalLesionSite.getTextMention();
}
	public SpinalLesionSite(String individualURI, String textMention){
this.individual = 
...
@Override
public String toString(){
return "SpinalLesionSite [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",depth="+depth+",distance="+distance+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
