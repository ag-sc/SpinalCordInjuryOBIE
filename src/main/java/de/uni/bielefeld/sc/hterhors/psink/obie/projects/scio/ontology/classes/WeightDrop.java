...
static class WeightDropIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/WeightDrop";
...
if(weightDrop.getDistance()!=null)this.distance = (IDistance) IOBIEThing.getCloneConstructor(weightDrop.getDistance().getClass())	.newInstance(weightDrop.getDistance());
if(weightDrop.getDuration()!=null)this.duration = (IDuration) IOBIEThing.getCloneConstructor(weightDrop.getDuration().getClass())	.newInstance(weightDrop.getDuration());
if(weightDrop.getForce()!=null)this.force = (IForce) IOBIEThing.getCloneConstructor(weightDrop.getForce().getClass())	.newInstance(weightDrop.getForce());
this.textMention = weightDrop.getTextMention();
if(weightDrop.getWeight()!=null)this.weight = (IWeight) IOBIEThing.getCloneConstructor(weightDrop.getWeight().getClass())	.newInstance(weightDrop.getWeight());
}
	public WeightDrop(String individualURI, String textMention){
this.individual = 
...
@Override
public String toString(){
return "WeightDrop [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",distance="+distance+",duration="+duration+",force="+force+",serialVersionUID="+serialVersionUID+",textMention="+textMention+",weight="+weight+"]";}
