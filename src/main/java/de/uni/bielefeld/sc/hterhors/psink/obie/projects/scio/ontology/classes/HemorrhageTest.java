...
final public static Class<? extends AbstractIndividual> individualClassType = HemorrhageTestIndividual.class;
static class HemorrhageTestIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public HemorrhageTestIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "HemorrhageTestIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<HemorrhageTestIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final HemorrhageTestIndividual individual;
	@Override
...
for (int j = 0; j < hemorrhageTest.getMakesUseOfApparatus().size(); j++) {if (hemorrhageTest.getMakesUseOfApparatus().get(j) != null) {makesUseOfApparatus.add((IApparatus) IOBIEThing.getCloneConstructor(hemorrhageTest.getMakesUseOfApparatus().get(j).getClass()).newInstance(hemorrhageTest.getMakesUseOfApparatus().get(j)));} else {makesUseOfApparatus.add(null);}}
this.textMention = hemorrhageTest.getTextMention();
}
...
<p>*/
@Override
	public HemorrhageTest addLocation(ILocation location){
...
<p>*/
@Override
	public HemorrhageTest addMakesUseOfApparatus(IApparatus apparatus){
...
return false;
HemorrhageTest other = (HemorrhageTest) obj;
if (individual == null) {
...
<p>*/
@Override
	public HemorrhageTest setLocations(List<ILocation> locations){
...
<p>*/
@Override
	public HemorrhageTest setMakesUseOfApparatus(List<IApparatus> apparatus){
