...
static class RehabilitativeTrainingIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/RehabilitativeTraining";
...
if(rehabilitativeTraining.getDuration()!=null)this.duration = (IDuration) IOBIEThing.getCloneConstructor(rehabilitativeTraining.getDuration().getClass())	.newInstance(rehabilitativeTraining.getDuration());
...
this.textMention = rehabilitativeTraining.getTextMention();
	...
	public RehabilitativeTraining(String individualURI, String textMention){
this.individual = 
...
@Override
public String toString(){
return "RehabilitativeTraining [individual="+individual+",applicationInstrument="+applicationInstrument+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",deliveryMethod="+deliveryMethod+",directions="+directions+",duration="+duration+",frequency="+frequency+",interval="+interval+",location="+location+",serialVersionUID="+serialVersionUID+",temporalIntervals="+temporalIntervals+",textMention="+textMention+"]";}
