...
<p>http://purl.bioontology.org/ontology/SNOMEDCT/251560006
<p>
<p><b>scio:descriptionSource</b>
<p>http://purl.bioontology.org/ontology/MESH/D006181
<p>
<p><b>rdfs:label</b>
<p>h reflex test
<p>
<p><b>rdfs:description</b>
<p>H Reflex Test is an examination of the monosynaptic H reflex elicited by stimulating a nerve, particularly the tibial nerve, with an electric shock.
<p>
*
* @author hterhors
*
...
final public static Class<? extends AbstractIndividual> individualClassType = HReflexTestIndividual.class;
static class HReflexTestIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public HReflexTestIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "HReflexTestIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<HReflexTestIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final HReflexTestIndividual individual;
	@Override
...
<p>*/
@Override
	public HReflexTest addMakesUseOfApparatus(IApparatus apparatus){
...
<p>*/
@Override
	public HReflexTest addTestsForFunction(IFunction function){
...
return false;
HReflexTest other = (HReflexTest) obj;
if (individual == null) {
...
<p>*/
@Override
	public HReflexTest setDuration(IDuration duration){
...
<p>*/
@Override
	public HReflexTest setMakesUseOfApparatus(List<IApparatus> apparatus){
...
<p>*/
@Override
	public HReflexTest setTestsForFunctions(List<IFunction> functions){
