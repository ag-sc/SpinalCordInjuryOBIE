...
static class AcetylsalicylicAcidIndividual extends AbstractIndividual {
	...
	@Override
	public AcetylsalicylicAcid setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/AcetylsalicylicAcid";
...
this.investigationRestriction = acetylsalicylicAcid.investigationRestriction;
...
if(acetylsalicylicAcid.getTissueSourceAnatomicalLocation()!=null)this.tissueSourceAnatomicalLocation = (IAnatomicalLocation) IOBIEThing.getCloneConstructor(acetylsalicylicAcid.getTissueSourceAnatomicalLocation().getClass())	.newInstance(acetylsalicylicAcid.getTissueSourceAnatomicalLocation());
	...
	public AcetylsalicylicAcid(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
@Override
public String toString(){
return "AcetylsalicylicAcid [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",compoundSupplier="+compoundSupplier+",serialVersionUID="+serialVersionUID+",textMention="+textMention+",tissueSourceAnatomicalLocation="+tissueSourceAnatomicalLocation+"]";}
