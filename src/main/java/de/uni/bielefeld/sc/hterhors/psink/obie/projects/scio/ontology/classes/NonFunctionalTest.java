...
final public static Class<? extends AbstractIndividual> individualClassType = NonFunctionalTestIndividual.class;
static class NonFunctionalTestIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public NonFunctionalTestIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "NonFunctionalTestIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<NonFunctionalTestIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final NonFunctionalTestIndividual individual;
	@Override
...
<p>*/
@Override
	public NonFunctionalTest addLocation(ILocation location){
...
<p>*/
@Override
	public NonFunctionalTest addMakesUseOfApparatus(IApparatus apparatus){
...
return false;
NonFunctionalTest other = (NonFunctionalTest) obj;
if (individual == null) {
...
<p>*/
@Override
	public NonFunctionalTest setLocations(List<ILocation> locations){
...
<p>*/
@Override
	public NonFunctionalTest setMakesUseOfApparatus(List<IApparatus> apparatus){
