...
static class CompoundBiologicalRelationIndividual extends AbstractIndividual {
	...
	@Override
	public CompoundBiologicalRelation setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/CompoundBiologicalRelation";
...
this.textMention = null;
	...
	public CompoundBiologicalRelation(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
this.investigationRestriction = compoundBiologicalRelation.investigationRestriction;
...
@Override
public String toString(){
return "CompoundBiologicalRelation [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
