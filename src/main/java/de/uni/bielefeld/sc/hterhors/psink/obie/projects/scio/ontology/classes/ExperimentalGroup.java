...
static class ExperimentalGroupIndividual extends AbstractIndividual {
	...
	@Override
	public ExperimentalGroup setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/ExperimentalGroup";
...
this.textMention = null;
	...
	public ExperimentalGroup(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
this.investigationRestriction = experimentalGroup.investigationRestriction;
...
@Override
public String toString(){
return "ExperimentalGroup [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",groupNames="+groupNames+",groupNumber="+groupNumber+",injuryModel="+injuryModel+",nNumber="+nNumber+",organismModel="+organismModel+",serialVersionUID="+serialVersionUID+",textMention="+textMention+",totalPopulationSize="+totalPopulationSize+",treatmentTypes="+treatmentTypes+"]";}
