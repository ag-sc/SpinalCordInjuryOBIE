...
static class ClipIndividual extends AbstractIndividual {
	...
	@Override
	public Clip setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/Clip";
...
private IWeight weight;
	...
	public Clip(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
this.investigationRestriction = clip.investigationRestriction;
this.characterOffset = clip.getCharacterOffset();
this.characterOnset = clip.getCharacterOnset();
if(clip.getDuration()!=null)this.duration = new Duration((Duration)clip.getDuration());
if(clip.getForce()!=null)this.force = new Force((Force)clip.getForce());
this.textMention = clip.getTextMention();
if(clip.getWeight()!=null)this.weight = new Weight((Weight)clip.getWeight());
}
...
@Override
public String toString(){
return "Clip [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",duration="+duration+",force="+force+",serialVersionUID="+serialVersionUID+",textMention="+textMention+",weight="+weight+"]";}
