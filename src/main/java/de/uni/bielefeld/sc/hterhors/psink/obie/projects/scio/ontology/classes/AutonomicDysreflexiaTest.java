...
static class AutonomicDysreflexiaTestIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/AutonomicDysreflexiaTest";
...
final private String textMention;
	...
	public AutonomicDysreflexiaTest(String individualURI, String textMention){
this.individual = 
...
if(autonomicDysreflexiaTest.getDuration()!=null)this.duration = (IDuration) IOBIEThing.getCloneConstructor(autonomicDysreflexiaTest.getDuration().getClass())	.newInstance(autonomicDysreflexiaTest.getDuration());
...
@Override
public String toString(){
return "AutonomicDysreflexiaTest [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",duration="+duration+",makesUseOfApparatus="+makesUseOfApparatus+",serialVersionUID="+serialVersionUID+",testsForFunctions="+testsForFunctions+",textMention="+textMention+"]";}
