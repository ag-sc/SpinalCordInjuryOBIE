...
static class ForelimbAsymmetryTestIndividual extends AbstractIndividual {
	...
	@Override
	public ForelimbAsymmetryTest setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/ForelimbAsymmetryTest";
...
this.investigationRestriction = forelimbAsymmetryTest.investigationRestriction;
this.characterOffset = forelimbAsymmetryTest.getCharacterOffset();
this.characterOnset = forelimbAsymmetryTest.getCharacterOnset();
if(forelimbAsymmetryTest.getDuration()!=null)this.duration = new Duration((Duration)forelimbAsymmetryTest.getDuration());
...
this.textMention = forelimbAsymmetryTest.getTextMention();
	...
	public ForelimbAsymmetryTest(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
@Override
public String toString(){
return "ForelimbAsymmetryTest [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",duration="+duration+",makesUseOfApparatus="+makesUseOfApparatus+",serialVersionUID="+serialVersionUID+",testsForFunctions="+testsForFunctions+",textMention="+textMention+"]";}
