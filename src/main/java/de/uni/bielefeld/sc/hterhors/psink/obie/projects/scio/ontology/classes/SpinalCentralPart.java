...
static class SpinalCentralPartIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/SpinalCentralPart";
...
this.textMention = null;
	...
	public SpinalCentralPart(String individualURI, String textMention){
this.individual = 
...
if(spinalCentralPart.getDepth()!=null)this.depth = (IDepth) IOBIEThing.getCloneConstructor(spinalCentralPart.getDepth().getClass())	.newInstance(spinalCentralPart.getDepth());
if(spinalCentralPart.getDistance()!=null)this.distance = (IDistance) IOBIEThing.getCloneConstructor(spinalCentralPart.getDistance().getClass())	.newInstance(spinalCentralPart.getDistance());
...
@Override
public String toString(){
return "SpinalCentralPart [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",depth="+depth+",distance="+distance+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
