...
final public static IndividualFactory<AnimalModelIndividual> individualFactory = new IndividualFactory<>();
final public static Class<? extends AbstractIndividual> individualClassType = AnimalModelIndividual.class;
static class AnimalModelIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public AnimalModelIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "AnimalModelIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<AnimalModelIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final AnimalModelIndividual individual;
	@Override
...
<p>*/
@Override
	public AnimalModel setAge(IAge age){
		this.age = age;
return this;}
	/**
<p><b>scio:example</b>
...
<p>*/
@Override
	public AnimalModel setAgeCategory(IAgeCategory ageCategory){
...
<p>*/
@Override
	public AnimalModel setGender(IGender gender){
		this.gender = gender;
return this;}
	/**
<p><b>rdfs:label</b>
...
<p>*/
@Override
	public AnimalModel setOrganismSpecies(IOrganismSpecies organismSpecies){
...
<p>*/
@Override
	public AnimalModel setWeight(IWeight weight){
		this.weight = weight;
return this;}
