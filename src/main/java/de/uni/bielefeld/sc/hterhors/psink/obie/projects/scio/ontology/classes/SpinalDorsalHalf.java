...
static class SpinalDorsalHalfIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/SpinalDorsalHalf";
...
if(spinalDorsalHalf.getDepth()!=null)this.depth = (IDepth) IOBIEThing.getCloneConstructor(spinalDorsalHalf.getDepth().getClass())	.newInstance(spinalDorsalHalf.getDepth());
if(spinalDorsalHalf.getDistance()!=null)this.distance = (IDistance) IOBIEThing.getCloneConstructor(spinalDorsalHalf.getDistance().getClass())	.newInstance(spinalDorsalHalf.getDistance());
this.textMention = spinalDorsalHalf.getTextMention();
}
	public SpinalDorsalHalf(String individualURI, String textMention){
this.individual = 
...
@Override
public String toString(){
return "SpinalDorsalHalf [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",depth="+depth+",distance="+distance+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
