...
<p>https://www.ncbi.nlm.nih.gov/mesh/68008550
<p>
<p><b>rdfs:label</b>
<p>melatonin
<p>
<p><b>rdfs:description</b>
<p>Melatonin is a a biogenic amine that is found in animals and plants. In mammals, melatonin is produced by the PINEAL GLAND. Its secretion increases in darkness and decreases during exposure to light. Melatonin is implicated in the regulation of SLEEP, mood, and REPRODUCTION. Melatonin is also an effective antioxidant.
<p>
*
* @author hterhors
*
...
final public static Class<? extends AbstractIndividual> individualClassType = MelatoninIndividual.class;
static class MelatoninIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public MelatoninIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "MelatoninIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<MelatoninIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final MelatoninIndividual individual;
	@Override
...
this.textMention = melatonin.getTextMention();
if(melatonin.getTissueSourceAnatomicalLocation()!=null)this.tissueSourceAnatomicalLocation = (IAnatomicalLocation) IOBIEThing.getCloneConstructor(melatonin.getTissueSourceAnatomicalLocation().getClass())	.newInstance(melatonin.getTissueSourceAnatomicalLocation());
}
...
<p>*/
@Override
	public Melatonin setCompoundSupplier(ICompoundSupplier compoundSupplier){
...
<p>*/
@Override
	public Melatonin setTissueSourceAnatomicalLocation(IAnatomicalLocation anatomicalLocation){
