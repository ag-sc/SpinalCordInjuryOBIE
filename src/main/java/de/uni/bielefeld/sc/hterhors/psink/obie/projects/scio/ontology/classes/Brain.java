...
static class BrainIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/Brain";
...
final private String textMention;
	...
	public Brain(String individualURI, String textMention){
this.individual = 
...
if(brain.getDepth()!=null)this.depth = (IDepth) IOBIEThing.getCloneConstructor(brain.getDepth().getClass())	.newInstance(brain.getDepth());
if(brain.getDistance()!=null)this.distance = (IDistance) IOBIEThing.getCloneConstructor(brain.getDistance().getClass())	.newInstance(brain.getDistance());
...
@Override
public String toString(){
return "Brain [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",depth="+depth+",distance="+distance+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
