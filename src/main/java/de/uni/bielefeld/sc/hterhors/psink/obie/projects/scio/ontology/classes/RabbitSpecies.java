...
static class RabbitSpeciesIndividual extends AbstractIndividual {
	...
	@Override
	public RabbitSpecies setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/RabbitSpecies";
...
this.investigationRestriction = rabbitSpecies.investigationRestriction;
...
this.textMention = rabbitSpecies.getTextMention();
	...
	public RabbitSpecies(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
@Override
public String toString(){
return "RabbitSpecies [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
