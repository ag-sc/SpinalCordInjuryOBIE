...
final public static Class<? extends AbstractIndividual> individualClassType = NeuroprotectionTestIndividual.class;
static class NeuroprotectionTestIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public NeuroprotectionTestIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "NeuroprotectionTestIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<NeuroprotectionTestIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final NeuroprotectionTestIndividual individual;
	@Override
...
<p>*/
@Override
	public NeuroprotectionTest addLocation(ILocation location){
...
<p>*/
@Override
	public NeuroprotectionTest addMakesUseOfApparatus(IApparatus apparatus){
...
return false;
NeuroprotectionTest other = (NeuroprotectionTest) obj;
if (individual == null) {
...
<p>*/
@Override
	public NeuroprotectionTest setLocations(List<ILocation> locations){
...
<p>*/
@Override
	public NeuroprotectionTest setMakesUseOfApparatus(List<IApparatus> apparatus){
