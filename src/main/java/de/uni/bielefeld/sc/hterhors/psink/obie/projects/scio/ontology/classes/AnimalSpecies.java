...
static class AnimalSpeciesIndividual extends AbstractIndividual {
	...
	@Override
	public AnimalSpecies setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/AnimalSpecies";
...
this.investigationRestriction = animalSpecies.investigationRestriction;
...
this.textMention = animalSpecies.getTextMention();
	...
	public AnimalSpecies(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
@Override
public String toString(){
return "AnimalSpecies [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
