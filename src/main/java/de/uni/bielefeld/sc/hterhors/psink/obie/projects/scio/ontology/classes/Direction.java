...
static class DirectionIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/Direction";
...
this.textMention = direction.getTextMention();
	...
	public Direction(String individualURI, String textMention){
this.individual = 
...
@Override
public String toString(){
return "Direction [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",relativeToLocation="+relativeToLocation+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
