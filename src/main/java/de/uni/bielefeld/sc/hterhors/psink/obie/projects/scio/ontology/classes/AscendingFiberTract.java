...
final public static Class<? extends AbstractIndividual> individualClassType = AscendingFiberTractIndividual.class;
static class AscendingFiberTractIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public AscendingFiberTractIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "AscendingFiberTractIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<AscendingFiberTractIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final AscendingFiberTractIndividual individual;
	@Override
...
return false;
AscendingFiberTract other = (AscendingFiberTract) obj;
if (individual == null) {
...
<p>*/
@Override
	public AscendingFiberTract setDepth(IDepth depth){
		this.depth = depth;
return this;}
	/**
<p><b>scio:example</b>
...
<p>*/
@Override
	public AscendingFiberTract setDistance(IDistance distance){
