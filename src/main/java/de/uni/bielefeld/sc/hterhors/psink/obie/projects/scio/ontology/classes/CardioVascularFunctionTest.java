...
static class CardioVascularFunctionTestIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/CardioVascularFunctionTest";
...
if(cardioVascularFunctionTest.getDuration()!=null)this.duration = (IDuration) IOBIEThing.getCloneConstructor(cardioVascularFunctionTest.getDuration().getClass())	.newInstance(cardioVascularFunctionTest.getDuration());
...
this.textMention = cardioVascularFunctionTest.getTextMention();
	...
	public CardioVascularFunctionTest(String individualURI, String textMention){
this.individual = 
...
@Override
public String toString(){
return "CardioVascularFunctionTest [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",duration="+duration+",makesUseOfApparatus="+makesUseOfApparatus+",serialVersionUID="+serialVersionUID+",testsForFunctions="+testsForFunctions+",textMention="+textMention+"]";}
