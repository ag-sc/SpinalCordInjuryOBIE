...
static class TreadmillTrainingIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/TreadmillTraining";
...
if(treadmillTraining.getDuration()!=null)this.duration = (IDuration) IOBIEThing.getCloneConstructor(treadmillTraining.getDuration().getClass())	.newInstance(treadmillTraining.getDuration());
...
this.textMention = treadmillTraining.getTextMention();
	...
	public TreadmillTraining(String individualURI, String textMention){
this.individual = 
...
@Override
public String toString(){
return "TreadmillTraining [individual="+individual+",applicationInstrument="+applicationInstrument+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",deliveryMethod="+deliveryMethod+",directions="+directions+",duration="+duration+",frequency="+frequency+",interval="+interval+",location="+location+",serialVersionUID="+serialVersionUID+",temporalIntervals="+temporalIntervals+",textMention="+textMention+"]";}
