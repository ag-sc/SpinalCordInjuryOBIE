...
final public static Class<? extends AbstractIndividual> individualClassType = ExtremityIndividual.class;
static class ExtremityIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public ExtremityIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "ExtremityIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<ExtremityIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final ExtremityIndividual individual;
	@Override
...
<p>*/
@Override
	public Extremity setDepth(IDepth depth){
		this.depth = depth;
return this;}
	/**
<p><b>scio:example</b>
...
<p>*/
@Override
	public Extremity setDistance(IDistance distance){
