...
static class MouseModelIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/MouseModel";
...
if(mouseModel.getAge()!=null)this.age = (IAge) IOBIEThing.getCloneConstructor(mouseModel.getAge().getClass())	.newInstance(mouseModel.getAge());
...
if(mouseModel.getWeight()!=null)this.weight = (IWeight) IOBIEThing.getCloneConstructor(mouseModel.getWeight().getClass())	.newInstance(mouseModel.getWeight());
}
	public MouseModel(String individualURI, String textMention){
this.individual = 
...
@Override
public String toString(){
return "MouseModel [individual="+individual+",age="+age+",ageCategory="+ageCategory+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",gender="+gender+",organismSpecies="+organismSpecies+",serialVersionUID="+serialVersionUID+",textMention="+textMention+",weight="+weight+"]";}
