...
final public static IndividualFactory<ElectromagneticFieldTreatmentIndividual> individualFactory = new IndividualFactory<>();
final public static Class<? extends AbstractIndividual> individualClassType = ElectromagneticFieldTreatmentIndividual.class;
static class ElectromagneticFieldTreatmentIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public ElectromagneticFieldTreatmentIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "ElectromagneticFieldTreatmentIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<ElectromagneticFieldTreatmentIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final ElectromagneticFieldTreatmentIndividual individual;
	@Override
...
<p>*/
@Override
	public ElectromagneticFieldTreatment addDirection(IDirection direction){
...
<p>*/
@Override
	public ElectromagneticFieldTreatment addTemporalInterval(ITemporalInterval temporalInterval){
...
return false;
ElectromagneticFieldTreatment other = (ElectromagneticFieldTreatment) obj;
if (individual == null) {
...
<p>*/
@Override
	public ElectromagneticFieldTreatment setApplicationInstrument(IApplicationInstrument applicationInstrument){
...
<p>*/
@Override
	public ElectromagneticFieldTreatment setCurrent(ICurrent current){
...
<p>*/
@Override
	public ElectromagneticFieldTreatment setDeliveryMethod(IDeliveryMethod deliveryMethod){
...
<p>*/
@Override
	public ElectromagneticFieldTreatment setDirections(List<IDirection> directions){
...
<p>*/
@Override
	public ElectromagneticFieldTreatment setDuration(IDuration duration){
...
<p>*/
@Override
	public ElectromagneticFieldTreatment setElectricFieldStrength(IElectricFieldStrength electricFieldStrength){
...
<p>*/
@Override
	public ElectromagneticFieldTreatment setFrequency(IFrequency frequency){
...
<p>*/
@Override
	public ElectromagneticFieldTreatment setInterval(IInterval interval){
...
<p>*/
@Override
	public ElectromagneticFieldTreatment setLocation(ILocation location){
...
<p>*/
@Override
	public ElectromagneticFieldTreatment setTemporalIntervals(List<ITemporalInterval> temporalIntervals){
...
<p>*/
@Override
	public ElectromagneticFieldTreatment setVoltage(IVoltage voltage){
