...
static class VertebralAreaIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/VertebralArea";
...
if(vertebralArea.getUpperVertebrae()!=null)this.upperVertebrae = (IVertebrae) IOBIEThing.getCloneConstructor(vertebralArea.getUpperVertebrae().getClass())	.newInstance(vertebralArea.getUpperVertebrae());
	...
	public VertebralArea(String individualURI, String textMention){
this.individual = 
...
@Override
public String toString(){
return "VertebralArea [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",lowerVertebrae="+lowerVertebrae+",serialVersionUID="+serialVersionUID+",textMention="+textMention+",upperVertebrae="+upperVertebrae+"]";}
