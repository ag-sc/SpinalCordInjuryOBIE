...
static class IntrathecalIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/Intrathecal";
...
if(intrathecal.getDepth()!=null)this.depth = (IDepth) IOBIEThing.getCloneConstructor(intrathecal.getDepth().getClass())	.newInstance(intrathecal.getDepth());
if(intrathecal.getDistance()!=null)this.distance = (IDistance) IOBIEThing.getCloneConstructor(intrathecal.getDistance().getClass())	.newInstance(intrathecal.getDistance());
this.textMention = intrathecal.getTextMention();
}
	public Intrathecal(String individualURI, String textMention){
this.individual = 
...
@Override
public String toString(){
return "Intrathecal [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",depth="+depth+",distance="+distance+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
