...
@DirectInterface(get=IIntrathecal.class)

@DirectSiblings(get={LesionAdjacentTissue.class, Intraspinal.class, Intrathecal.class, })

@AssignableSubClasses(get={Epidural.class, })
 public class Intrathecal implements IIntrathecal{

final public static IndividualFactory<IntrathecalIndividual> individualFactory = new IndividualFactory<>();
final public static Class<? extends AbstractIndividual> individualClassType = IntrathecalIndividual.class;
static class IntrathecalIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public IntrathecalIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "IntrathecalIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<IntrathecalIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final IntrathecalIndividual individual;
	@Override
	...
	@Override
	public Intrathecal setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/Intrathecal";
...
this.textMention = null;
	...
	public Intrathecal(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
				Intrathecal.individualFactory.getIndividualByURI(individualURI);
this.investigationRestriction = investigationRestriction==null?InvestigationRestriction.noRestrictionInstance:investigationRestriction;
this.textMention = textMention;
}
	public Intrathecal(Intrathecal intrathecal)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
this.individual = intrathecal.individual;
this.investigationRestriction = intrathecal.investigationRestriction;
this.characterOffset = intrathecal.getCharacterOffset();
this.characterOnset = intrathecal.getCharacterOnset();
if(intrathecal.getDepth()!=null)this.depth = new Depth((Depth)intrathecal.getDepth());
if(intrathecal.getDistance()!=null)this.distance = new Distance((Distance)intrathecal.getDistance());
this.textMention = intrathecal.getTextMention();
}
...
return false;
Intrathecal other = (Intrathecal) obj;
if (individual == null) {
...
<p>*/
@Override
	public Intrathecal setDepth(IDepth depth){
		this.depth = depth;
return this;}
	/**
<p><b>scio:example</b>
...
<p>*/
@Override
	public Intrathecal setDistance(IDistance distance){
...
@Override
public String toString(){
return "Intrathecal [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",depth="+depth+",distance="+distance+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
