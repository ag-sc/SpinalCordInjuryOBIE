...
@SuperRootClasses(get={Depth.class, })

@DirectSiblings(get={})

@DirectInterface(get=IDepth.class)
 public class Depth implements IDepth{

	final static public String ONTOLOGY_NAME = "http://psink.de/scio/Depth";
...
final private String textMention;
	...
	public Depth(String interpretedValue, String textMention){
this.interpretedValue = interpretedValue;
this.textMention = textMention;
}
	public Depth(String interpretedValue){
this.interpretedValue = interpretedValue;
...
this.characterOffset = depth.getCharacterOffset();
this.characterOnset = depth.getCharacterOnset();
this.interpretedValue = depth.getInterpretedValue();
this.textMention = depth.getTextMention();
}
...
return "Depth [characterOffset="+characterOffset+",characterOnset="+characterOnset+",interpretedValue="+interpretedValue+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
