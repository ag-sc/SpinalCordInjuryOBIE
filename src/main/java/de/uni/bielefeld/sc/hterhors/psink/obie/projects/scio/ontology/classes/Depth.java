...
this.textMention = null;
	...
	public Depth(String semanticValue, String textMention){
this.semanticValue = semanticValue;
this.textMention = textMention;
}
	public Depth(String semanticValue){
this.semanticValue = semanticValue;
this.textMention = null;
}
...
this.semanticValue = depth.getSemanticValue();
...
return "Depth [characterOffset="+characterOffset+",characterOnset="+characterOnset+",semanticValue="+semanticValue+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
