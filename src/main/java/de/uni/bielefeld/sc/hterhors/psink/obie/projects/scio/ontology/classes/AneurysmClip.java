...
static class AneurysmClipIndividual extends AbstractIndividual {
	...
	@Override
	public AneurysmClip setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/AneurysmClip";
...
private IWeight weight;
	...
	public AneurysmClip(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
this.investigationRestriction = aneurysmClip.investigationRestriction;
this.characterOffset = aneurysmClip.getCharacterOffset();
this.characterOnset = aneurysmClip.getCharacterOnset();
if(aneurysmClip.getDuration()!=null)this.duration = new Duration((Duration)aneurysmClip.getDuration());
if(aneurysmClip.getForce()!=null)this.force = new Force((Force)aneurysmClip.getForce());
this.textMention = aneurysmClip.getTextMention();
if(aneurysmClip.getWeight()!=null)this.weight = new Weight((Weight)aneurysmClip.getWeight());
}
	public AneurysmClip(){
...
@Override
public String toString(){
return "AneurysmClip [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",duration="+duration+",force="+force+",serialVersionUID="+serialVersionUID+",textMention="+textMention+",weight="+weight+"]";}
