...
static class PersonIndividual extends AbstractIndividual {
 ...
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/Person";
...
@Override
public String toString(){
return "Person [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",name="+name+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
