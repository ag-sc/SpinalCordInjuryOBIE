...
@AssignableSubClasses(get={NormothermicTreatment.class, HypothermicTreatment.class, })
 public class TemperatureTreatment implements ITemperatureTreatment{

final public static IndividualFactory<TemperatureTreatmentIndividual> individualFactory = new IndividualFactory<>();
final public static Class<? extends AbstractIndividual> individualClassType = TemperatureTreatmentIndividual.class;
static class TemperatureTreatmentIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public TemperatureTreatmentIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "TemperatureTreatmentIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<TemperatureTreatmentIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final TemperatureTreatmentIndividual individual;
	@Override
...
<p>*/
@Override
	public TemperatureTreatment addDirection(IDirection direction){
...
<p>*/
@Override
	public TemperatureTreatment addTemporalInterval(ITemporalInterval temporalInterval){
...
return false;
TemperatureTreatment other = (TemperatureTreatment) obj;
if (individual == null) {
...
<p>*/
@Override
	public TemperatureTreatment setApplicationInstrument(IApplicationInstrument applicationInstrument){
...
<p>*/
@Override
	public TemperatureTreatment setDeliveryMethod(IDeliveryMethod deliveryMethod){
...
<p>*/
@Override
	public TemperatureTreatment setDirections(List<IDirection> directions){
...
<p>*/
@Override
	public TemperatureTreatment setDuration(IDuration duration){
...
<p>*/
@Override
	public TemperatureTreatment setFrequency(IFrequency frequency){
...
<p>*/
@Override
	public TemperatureTreatment setInterval(IInterval interval){
...
<p>*/
@Override
	public TemperatureTreatment setLocation(ILocation location){
...
<p>*/
@Override
	public TemperatureTreatment setTemperature(ITemperature temperature){
...
<p>*/
@Override
	public TemperatureTreatment setTemporalIntervals(List<ITemporalInterval> temporalIntervals){
