...
static class MotorEvokedPotentialsTestIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/MotorEvokedPotentialsTest";
...
final private String textMention;
	...
	public MotorEvokedPotentialsTest(String individualURI, String textMention){
this.individual = 
...
if(motorEvokedPotentialsTest.getDuration()!=null)this.duration = (IDuration) IOBIEThing.getCloneConstructor(motorEvokedPotentialsTest.getDuration().getClass())	.newInstance(motorEvokedPotentialsTest.getDuration());
...
@Override
public String toString(){
return "MotorEvokedPotentialsTest [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",duration="+duration+",makesUseOfApparatus="+makesUseOfApparatus+",serialVersionUID="+serialVersionUID+",testsForFunctions="+testsForFunctions+",textMention="+textMention+"]";}
