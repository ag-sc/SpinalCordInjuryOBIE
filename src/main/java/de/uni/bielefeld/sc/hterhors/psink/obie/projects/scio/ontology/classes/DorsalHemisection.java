...
@DirectInterface(get=IDorsalHemisection.class)

@DirectSiblings(get={VentralHemisection.class, DorsalHemisection.class, LateralHemisection.class, })
 public class DorsalHemisection implements IDorsalHemisection{

final public static IndividualFactory<DorsalHemisectionIndividual> individualFactory = new IndividualFactory<>();
final public static Class<? extends AbstractIndividual> individualClassType = DorsalHemisectionIndividual.class;
static class DorsalHemisectionIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public DorsalHemisectionIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "DorsalHemisectionIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<DorsalHemisectionIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final DorsalHemisectionIndividual individual;
	@Override
	...
	@Override
	public DorsalHemisection setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/DorsalHemisection";
...
final private String textMention;
	...
	public DorsalHemisection(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
				DorsalHemisection.individualFactory.getIndividualByURI(individualURI);
this.investigationRestriction = investigationRestriction==null?InvestigationRestriction.noRestrictionInstance:investigationRestriction;
this.textMention = textMention;
}
	public DorsalHemisection(DorsalHemisection dorsalHemisection)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
this.individual = dorsalHemisection.individual;
this.investigationRestriction = dorsalHemisection.investigationRestriction;
for (int j = 0; j < dorsalHemisection.getAnimalCareConditions().size(); j++) {if (dorsalHemisection.getAnimalCareConditions().get(j) != null) {animalCareConditions.add((IAnimalCareCondition) IOBIEThing.getCloneConstructor(dorsalHemisection.getAnimalCareConditions().get(j).getClass()).newInstance(dorsalHemisection.getAnimalCareConditions().get(j)));} else {animalCareConditions.add(null);}}
this.characterOffset = dorsalHemisection.getCharacterOffset();
this.characterOnset = dorsalHemisection.getCharacterOnset();
for (int j = 0; j < dorsalHemisection.getInjuryAnaesthesiaAnaesthetics().size(); j++) {if (dorsalHemisection.getInjuryAnaesthesiaAnaesthetics().get(j) != null) {injuryAnaesthesiaAnaesthetics.add((IAnaesthetic) IOBIEThing.getCloneConstructor(dorsalHemisection.getInjuryAnaesthesiaAnaesthetics().get(j).getClass()).newInstance(dorsalHemisection.getInjuryAnaesthesiaAnaesthetics().get(j)));} else {injuryAnaesthesiaAnaesthetics.add(null);}}
if(dorsalHemisection.getInjuryArea()!=null)this.injuryArea = (IInjuryArea) IOBIEThing.getCloneConstructor(dorsalHemisection.getInjuryArea().getClass())	.newInstance(dorsalHemisection.getInjuryArea());
if(dorsalHemisection.getInjuryDevice()!=null)this.injuryDevice = (IInjuryDevice) IOBIEThing.getCloneConstructor(dorsalHemisection.getInjuryDevice().getClass())	.newInstance(dorsalHemisection.getInjuryDevice());
if(dorsalHemisection.getInjuryIntensity()!=null)this.injuryIntensity = (IInjuryIntensity) IOBIEThing.getCloneConstructor(dorsalHemisection.getInjuryIntensity().getClass())	.newInstance(dorsalHemisection.getInjuryIntensity());
for (int j = 0; j < dorsalHemisection.getInjuryPostsurgicalCareAnimalCareConditions().size(); j++) {if (dorsalHemisection.getInjuryPostsurgicalCareAnimalCareConditions().get(j) != null) {injuryPostsurgicalCareAnimalCareConditions.add((IAnimalCareCondition) IOBIEThing.getCloneConstructor(dorsalHemisection.getInjuryPostsurgicalCareAnimalCareConditions().get(j).getClass()).newInstance(dorsalHemisection.getInjuryPostsurgicalCareAnimalCareConditions().get(j)));} else {injuryPostsurgicalCareAnimalCareConditions.add(null);}}
if(dorsalHemisection.getInjuryVertebralLocation()!=null)this.injuryVertebralLocation = (IVertebralLocation) IOBIEThing.getCloneConstructor(dorsalHemisection.getInjuryVertebralLocation().getClass())	.newInstance(dorsalHemisection.getInjuryVertebralLocation());
for (int j = 0; j < dorsalHemisection.getMedicationDuringSurgeries().size(); j++) {if (dorsalHemisection.getMedicationDuringSurgeries().get(j) != null) {medicationDuringSurgeries.add((IMedicationDuringSurgery) IOBIEThing.getCloneConstructor(dorsalHemisection.getMedicationDuringSurgeries().get(j).getClass()).newInstance(dorsalHemisection.getMedicationDuringSurgeries().get(j)));} else {medicationDuringSurgeries.add(null);}}
for (int j = 0; j < dorsalHemisection.getTemporalIntervals().size(); j++) {if (dorsalHemisection.getTemporalIntervals().get(j) != null) {temporalIntervals.add((ITemporalInterval) IOBIEThing.getCloneConstructor(dorsalHemisection.getTemporalIntervals().get(j).getClass()).newInstance(dorsalHemisection.getTemporalIntervals().get(j)));} else {temporalIntervals.add(null);}}
this.textMention = dorsalHemisection.getTextMention();
}
	public DorsalHemisection(){
...
<p>*/
@Override
	public DorsalHemisection addAnimalCareCondition(IAnimalCareCondition animalCareCondition){
...
<p>*/
@Override
	public DorsalHemisection addInjuryAnaesthesiaAnaesthetic(IAnaesthetic anaesthetic){
...
<p>*/
@Override
	public DorsalHemisection addInjuryPostsurgicalCareAnimalCareCondition(IAnimalCareCondition animalCareCondition){
...
<p>*/
@Override
	public DorsalHemisection addMedicationDuringSurgery(IMedicationDuringSurgery medicationDuringSurgery){
...
<p>*/
@Override
	public DorsalHemisection addTemporalInterval(ITemporalInterval temporalInterval){
...
return false;
DorsalHemisection other = (DorsalHemisection) obj;
if (individual == null) {
...
<p>*/
@Override
	public DorsalHemisection setAnimalCareConditions(List<IAnimalCareCondition> animalCareConditions){
...
<p>*/
@Override
	public DorsalHemisection setInjuryAnaesthesiaAnaesthetics(List<IAnaesthetic> anaesthetics){
...
<p>*/
@Override
	public DorsalHemisection setInjuryArea(IInjuryArea injuryArea){
...
<p>*/
@Override
	public DorsalHemisection setInjuryDevice(IInjuryDevice injuryDevice){
...
<p>*/
@Override
	public DorsalHemisection setInjuryIntensity(IInjuryIntensity injuryIntensity){
...
<p>*/
@Override
	public DorsalHemisection setInjuryPostsurgicalCareAnimalCareConditions(List<IAnimalCareCondition> animalCareConditions){
...
<p>*/
@Override
	public DorsalHemisection setInjuryVertebralLocation(IVertebralLocation vertebralLocation){
...
<p>*/
@Override
	public DorsalHemisection setMedicationDuringSurgeries(List<IMedicationDuringSurgery> medicationDuringSurgeries){
...
<p>*/
@Override
	public DorsalHemisection setTemporalIntervals(List<ITemporalInterval> temporalIntervals){
...
@Override
public String toString(){
return "DorsalHemisection [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",animalCareConditions="+animalCareConditions+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",injuryAnaesthesiaAnaesthetics="+injuryAnaesthesiaAnaesthetics+",injuryArea="+injuryArea+",injuryDevice="+injuryDevice+",injuryIntensity="+injuryIntensity+",injuryPostsurgicalCareAnimalCareConditions="+injuryPostsurgicalCareAnimalCareConditions+",injuryVertebralLocation="+injuryVertebralLocation+",medicationDuringSurgeries="+medicationDuringSurgeries+",serialVersionUID="+serialVersionUID+",temporalIntervals="+temporalIntervals+",textMention="+textMention+"]";}
