...
static class ElectrophysiologyTestIndividual extends AbstractIndividual {
	...
	@Override
	public ElectrophysiologyTest setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/ElectrophysiologyTest";
...
this.investigationRestriction = electrophysiologyTest.investigationRestriction;
this.characterOffset = electrophysiologyTest.getCharacterOffset();
this.characterOnset = electrophysiologyTest.getCharacterOnset();
if(electrophysiologyTest.getDuration()!=null)this.duration = new Duration((Duration)electrophysiologyTest.getDuration());
...
this.textMention = electrophysiologyTest.getTextMention();
	...
	public ElectrophysiologyTest(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
