...
static class RepeatedMeasureTrendIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/RepeatedMeasureTrend";
...
this.textMention = repeatedMeasureTrend.getTextMention();
	...
	public RepeatedMeasureTrend(String individualURI, String textMention){
this.individual = 
...
@Override
public String toString(){
return "RepeatedMeasureTrend [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",observedDifference="+observedDifference+",serialVersionUID="+serialVersionUID+",significance="+significance+",textMention="+textMention+"]";}
