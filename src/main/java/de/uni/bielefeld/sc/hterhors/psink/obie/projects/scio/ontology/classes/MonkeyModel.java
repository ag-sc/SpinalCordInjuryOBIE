...
static class MonkeyModelIndividual extends AbstractIndividual {
	...
	@Override
	public MonkeyModel setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/MonkeyModel";
	@DatatypeProperty
...
this.textMention = null;
	...
	public MonkeyModel(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
this.investigationRestriction = monkeyModel.investigationRestriction;
if(monkeyModel.getAge()!=null)this.age = new Age((Age)monkeyModel.getAge());
...
if(monkeyModel.getWeight()!=null)this.weight = new Weight((Weight)monkeyModel.getWeight());
}
