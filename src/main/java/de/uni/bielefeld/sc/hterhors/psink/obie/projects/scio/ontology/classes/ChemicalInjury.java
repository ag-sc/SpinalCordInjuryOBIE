...
@DirectInterface(get=IChemicalInjury.class)
 public class ChemicalInjury implements IChemicalInjury{

final public static IndividualFactory<ChemicalInjuryIndividual> individualFactory = new IndividualFactory<>();
final public static Class<? extends AbstractIndividual> individualClassType = ChemicalInjuryIndividual.class;
static class ChemicalInjuryIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public ChemicalInjuryIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "ChemicalInjuryIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<ChemicalInjuryIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final ChemicalInjuryIndividual individual;
	@Override
	...
	@Override
	public ChemicalInjury setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/ChemicalInjury";
...
private List<IAnimalCareCondition> animalCareConditions = new ArrayList<>();
	...
	@OntologyModelContent(ontologyName="http://psink.de/scio/hasChemicalCompound")
@RelationTypeCollection
private List<ICompound> chemicalCompounds = new ArrayList<>();
...
final private String textMention;
	...
	public ChemicalInjury(ChemicalInjury chemicalInjury)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
this.individual = chemicalInjury.individual;
this.investigationRestriction = chemicalInjury.investigationRestriction;
for (int j = 0; j < chemicalInjury.getAnimalCareConditions().size(); j++) {if (chemicalInjury.getAnimalCareConditions().get(j) != null) {animalCareConditions.add((IAnimalCareCondition) IOBIEThing.getCloneConstructor(chemicalInjury.getAnimalCareConditions().get(j).getClass()).newInstance(chemicalInjury.getAnimalCareConditions().get(j)));} else {animalCareConditions.add(null);}}
this.characterOffset = chemicalInjury.getCharacterOffset();
this.characterOnset = chemicalInjury.getCharacterOnset();
for (int j = 0; j < chemicalInjury.getChemicalCompounds().size(); j++) {if (chemicalInjury.getChemicalCompounds().get(j) != null) {chemicalCompounds.add((ICompound) IOBIEThing.getCloneConstructor(chemicalInjury.getChemicalCompounds().get(j).getClass()).newInstance(chemicalInjury.getChemicalCompounds().get(j)));} else {chemicalCompounds.add(null);}}
for (int j = 0; j < chemicalInjury.getInjuryAnaesthesiaAnaesthetics().size(); j++) {if (chemicalInjury.getInjuryAnaesthesiaAnaesthetics().get(j) != null) {injuryAnaesthesiaAnaesthetics.add((IAnaesthetic) IOBIEThing.getCloneConstructor(chemicalInjury.getInjuryAnaesthesiaAnaesthetics().get(j).getClass()).newInstance(chemicalInjury.getInjuryAnaesthesiaAnaesthetics().get(j)));} else {injuryAnaesthesiaAnaesthetics.add(null);}}
if(chemicalInjury.getInjuryArea()!=null)this.injuryArea = (IInjuryArea) IOBIEThing.getCloneConstructor(chemicalInjury.getInjuryArea().getClass())	.newInstance(chemicalInjury.getInjuryArea());
if(chemicalInjury.getInjuryDevice()!=null)this.injuryDevice = (IInjuryDevice) IOBIEThing.getCloneConstructor(chemicalInjury.getInjuryDevice().getClass())	.newInstance(chemicalInjury.getInjuryDevice());
if(chemicalInjury.getInjuryIntensity()!=null)this.injuryIntensity = (IInjuryIntensity) IOBIEThing.getCloneConstructor(chemicalInjury.getInjuryIntensity().getClass())	.newInstance(chemicalInjury.getInjuryIntensity());
for (int j = 0; j < chemicalInjury.getInjuryPostsurgicalCareAnimalCareConditions().size(); j++) {if (chemicalInjury.getInjuryPostsurgicalCareAnimalCareConditions().get(j) != null) {injuryPostsurgicalCareAnimalCareConditions.add((IAnimalCareCondition) IOBIEThing.getCloneConstructor(chemicalInjury.getInjuryPostsurgicalCareAnimalCareConditions().get(j).getClass()).newInstance(chemicalInjury.getInjuryPostsurgicalCareAnimalCareConditions().get(j)));} else {injuryPostsurgicalCareAnimalCareConditions.add(null);}}
if(chemicalInjury.getInjuryVertebralLocation()!=null)this.injuryVertebralLocation = (IVertebralLocation) IOBIEThing.getCloneConstructor(chemicalInjury.getInjuryVertebralLocation().getClass())	.newInstance(chemicalInjury.getInjuryVertebralLocation());
for (int j = 0; j < chemicalInjury.getMedicationDuringSurgeries().size(); j++) {if (chemicalInjury.getMedicationDuringSurgeries().get(j) != null) {medicationDuringSurgeries.add((IMedicationDuringSurgery) IOBIEThing.getCloneConstructor(chemicalInjury.getMedicationDuringSurgeries().get(j).getClass()).newInstance(chemicalInjury.getMedicationDuringSurgeries().get(j)));} else {medicationDuringSurgeries.add(null);}}
for (int j = 0; j < chemicalInjury.getTemporalIntervals().size(); j++) {if (chemicalInjury.getTemporalIntervals().get(j) != null) {temporalIntervals.add((ITemporalInterval) IOBIEThing.getCloneConstructor(chemicalInjury.getTemporalIntervals().get(j).getClass()).newInstance(chemicalInjury.getTemporalIntervals().get(j)));} else {temporalIntervals.add(null);}}
this.textMention = chemicalInjury.getTextMention();
}
	public ChemicalInjury(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
				ChemicalInjury.individualFactory.getIndividualByURI(individualURI);
this.investigationRestriction = investigationRestriction==null?InvestigationRestriction.noRestrictionInstance:investigationRestriction;
this.textMention = textMention;
}
	public ChemicalInjury(){
...
<p>*/
@Override
	public ChemicalInjury addAnimalCareCondition(IAnimalCareCondition animalCareCondition){
...
<p>*/
@Override
	public ChemicalInjury addChemicalCompound(ICompound compound){
		this.chemicalCompounds.add(compound);
return this;}
	/**
<p><b>scio:example</b>
...
<p>*/
@Override
	public ChemicalInjury addInjuryAnaesthesiaAnaesthetic(IAnaesthetic anaesthetic){
...
<p>*/
@Override
	public ChemicalInjury addInjuryPostsurgicalCareAnimalCareCondition(IAnimalCareCondition animalCareCondition){
...
<p>*/
@Override
	public ChemicalInjury addMedicationDuringSurgery(IMedicationDuringSurgery medicationDuringSurgery){
...
<p>*/
@Override
	public ChemicalInjury addTemporalInterval(ITemporalInterval temporalInterval){
...
return false;
ChemicalInjury other = (ChemicalInjury) obj;
if (individual == null) {
...
return false;
if (chemicalCompounds == null) {
if (other.chemicalCompounds!= null)
return false;
} else if (!chemicalCompounds.equals(other.chemicalCompounds))
return false;
if (injuryArea == null) {
...
result = prime * result + ((this.chemicalCompounds == null) ? 0 : this.chemicalCompounds.hashCode());
...
<p>*/
@Override
	public ChemicalInjury setAnimalCareConditions(List<IAnimalCareCondition> animalCareConditions){
...
<p>*/
@Override
	public ChemicalInjury setChemicalCompounds(List<ICompound> compounds){
		if(compounds==null){throw new IllegalArgumentException("Can not set list objects to null.");}this.chemicalCompounds = compounds;
return this;}
	/**
<p><b>scio:example</b>
<p>The animals were anesthetized by an intraperitoneal (ip) injection of 10 mg/kg xylasine (Bayer Birlesik Alman _Ilac¸ Fabrikalari T.A.S., Istanbul, Turkey) and 50 mg/kg ketamine hydrochloride (Parke Davis, _Istanbul, Turkey).
...
<p>*/
@Override
	public ChemicalInjury setInjuryAnaesthesiaAnaesthetics(List<IAnaesthetic> anaesthetics){
...
<p>*/
@Override
	public ChemicalInjury setInjuryArea(IInjuryArea injuryArea){
...
<p>*/
@Override
	public ChemicalInjury setInjuryDevice(IInjuryDevice injuryDevice){
...
<p>*/
@Override
	public ChemicalInjury setInjuryIntensity(IInjuryIntensity injuryIntensity){
...
<p>*/
@Override
	public ChemicalInjury setInjuryPostsurgicalCareAnimalCareConditions(List<IAnimalCareCondition> animalCareConditions){
...
<p>*/
@Override
	public ChemicalInjury setInjuryVertebralLocation(IVertebralLocation vertebralLocation){
...
<p>*/
@Override
	public ChemicalInjury setMedicationDuringSurgeries(List<IMedicationDuringSurgery> medicationDuringSurgeries){
...
<p>*/
@Override
	public ChemicalInjury setTemporalIntervals(List<ITemporalInterval> temporalIntervals){
...
@Override
public String toString(){
return "ChemicalInjury [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",animalCareConditions="+animalCareConditions+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",chemicalCompounds="+chemicalCompounds+",injuryAnaesthesiaAnaesthetics="+injuryAnaesthesiaAnaesthetics+",injuryArea="+injuryArea+",injuryDevice="+injuryDevice+",injuryIntensity="+injuryIntensity+",injuryPostsurgicalCareAnimalCareConditions="+injuryPostsurgicalCareAnimalCareConditions+",injuryVertebralLocation="+injuryVertebralLocation+",medicationDuringSurgeries="+medicationDuringSurgeries+",serialVersionUID="+serialVersionUID+",temporalIntervals="+temporalIntervals+",textMention="+textMention+"]";}
