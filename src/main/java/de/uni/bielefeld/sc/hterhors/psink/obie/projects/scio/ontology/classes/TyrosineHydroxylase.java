...
static class TyrosineHydroxylaseIndividual extends AbstractIndividual {
	...
	@Override
	public TyrosineHydroxylase setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/TyrosineHydroxylase";
...
this.investigationRestriction = tyrosineHydroxylase.investigationRestriction;
...
if(tyrosineHydroxylase.getTissueSourceAnatomicalLocation()!=null)this.tissueSourceAnatomicalLocation = (IAnatomicalLocation) IOBIEThing.getCloneConstructor(tyrosineHydroxylase.getTissueSourceAnatomicalLocation().getClass())	.newInstance(tyrosineHydroxylase.getTissueSourceAnatomicalLocation());
	...
	public TyrosineHydroxylase(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
...
@Override
public String toString(){
return "TyrosineHydroxylase [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",compoundSupplier="+compoundSupplier+",serialVersionUID="+serialVersionUID+",textMention="+textMention+",tissueSourceAnatomicalLocation="+tissueSourceAnatomicalLocation+"]";}
