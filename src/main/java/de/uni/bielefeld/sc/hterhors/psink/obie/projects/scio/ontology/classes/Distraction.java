...
<p>Distraction is a process leading to spinal cord injury by lengthening the vertebral column by gradual mechanical distraction.
<p>
*
* @author hterhors
*
...
@DirectInterface(get=IDistraction.class)
...
@DirectSiblings(get={CompleteTransection.class, Compression.class, Contusion.class, Laminectomy.class, ElectrolyticLesion.class, PhotochemicalInjury.class, Dislocation.class, InjuryByAccident.class, PartialTransection.class, Distraction.class, AspirationLesion.class, ChemicalInjury.class, HeatLesion.class, })
 public class Distraction implements IDistraction{

final public static IndividualFactory<DistractionIndividual> individualFactory = new IndividualFactory<>();
final public static Class<? extends AbstractIndividual> individualClassType = DistractionIndividual.class;
static class DistractionIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public DistractionIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "DistractionIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<DistractionIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final DistractionIndividual individual;
	@Override
	...
	@Override
	public Distraction setInvestigationRestriction(InvestigationRestriction investigationRestriction ) {
		this.investigationRestriction = investigationRestriction;
 return this;	}public InvestigationRestriction investigationRestriction;	final static public String ONTOLOGY_NAME = "http://psink.de/scio/Distraction";
...
final private String textMention;
	...
	public Distraction(String individualURI, InvestigationRestriction investigationRestriction, String textMention){
this.individual = 
				Distraction.individualFactory.getIndividualByURI(individualURI);
this.investigationRestriction = investigationRestriction==null?InvestigationRestriction.noRestrictionInstance:investigationRestriction;
this.textMention = textMention;
}
	public Distraction(Distraction distraction)throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,NoSuchMethodException, SecurityException{
this.individual = distraction.individual;
this.investigationRestriction = distraction.investigationRestriction;
for (int j = 0; j < distraction.getAnimalCareConditions().size(); j++) {if (distraction.getAnimalCareConditions().get(j) != null) {animalCareConditions.add((IAnimalCareCondition) IOBIEThing.getCloneConstructor(distraction.getAnimalCareConditions().get(j).getClass()).newInstance(distraction.getAnimalCareConditions().get(j)));} else {animalCareConditions.add(null);}}
this.characterOffset = distraction.getCharacterOffset();
this.characterOnset = distraction.getCharacterOnset();
for (int j = 0; j < distraction.getInjuryAnaesthesiaAnaesthetics().size(); j++) {if (distraction.getInjuryAnaesthesiaAnaesthetics().get(j) != null) {injuryAnaesthesiaAnaesthetics.add((IAnaesthetic) IOBIEThing.getCloneConstructor(distraction.getInjuryAnaesthesiaAnaesthetics().get(j).getClass()).newInstance(distraction.getInjuryAnaesthesiaAnaesthetics().get(j)));} else {injuryAnaesthesiaAnaesthetics.add(null);}}
if(distraction.getInjuryArea()!=null)this.injuryArea = (IInjuryArea) IOBIEThing.getCloneConstructor(distraction.getInjuryArea().getClass())	.newInstance(distraction.getInjuryArea());
if(distraction.getInjuryDevice()!=null)this.injuryDevice = (IInjuryDevice) IOBIEThing.getCloneConstructor(distraction.getInjuryDevice().getClass())	.newInstance(distraction.getInjuryDevice());
if(distraction.getInjuryIntensity()!=null)this.injuryIntensity = (IInjuryIntensity) IOBIEThing.getCloneConstructor(distraction.getInjuryIntensity().getClass())	.newInstance(distraction.getInjuryIntensity());
for (int j = 0; j < distraction.getInjuryPostsurgicalCareAnimalCareConditions().size(); j++) {if (distraction.getInjuryPostsurgicalCareAnimalCareConditions().get(j) != null) {injuryPostsurgicalCareAnimalCareConditions.add((IAnimalCareCondition) IOBIEThing.getCloneConstructor(distraction.getInjuryPostsurgicalCareAnimalCareConditions().get(j).getClass()).newInstance(distraction.getInjuryPostsurgicalCareAnimalCareConditions().get(j)));} else {injuryPostsurgicalCareAnimalCareConditions.add(null);}}
if(distraction.getInjuryVertebralLocation()!=null)this.injuryVertebralLocation = (IVertebralLocation) IOBIEThing.getCloneConstructor(distraction.getInjuryVertebralLocation().getClass())	.newInstance(distraction.getInjuryVertebralLocation());
for (int j = 0; j < distraction.getMedicationDuringSurgeries().size(); j++) {if (distraction.getMedicationDuringSurgeries().get(j) != null) {medicationDuringSurgeries.add((IMedicationDuringSurgery) IOBIEThing.getCloneConstructor(distraction.getMedicationDuringSurgeries().get(j).getClass()).newInstance(distraction.getMedicationDuringSurgeries().get(j)));} else {medicationDuringSurgeries.add(null);}}
for (int j = 0; j < distraction.getTemporalIntervals().size(); j++) {if (distraction.getTemporalIntervals().get(j) != null) {temporalIntervals.add((ITemporalInterval) IOBIEThing.getCloneConstructor(distraction.getTemporalIntervals().get(j).getClass()).newInstance(distraction.getTemporalIntervals().get(j)));} else {temporalIntervals.add(null);}}
this.textMention = distraction.getTextMention();
}
	public Distraction(){
...
<p>*/
@Override
	public Distraction addAnimalCareCondition(IAnimalCareCondition animalCareCondition){
...
<p>*/
@Override
	public Distraction addInjuryAnaesthesiaAnaesthetic(IAnaesthetic anaesthetic){
...
<p>*/
@Override
	public Distraction addInjuryPostsurgicalCareAnimalCareCondition(IAnimalCareCondition animalCareCondition){
...
<p>*/
@Override
	public Distraction addMedicationDuringSurgery(IMedicationDuringSurgery medicationDuringSurgery){
...
<p>*/
@Override
	public Distraction addTemporalInterval(ITemporalInterval temporalInterval){
...
return false;
Distraction other = (Distraction) obj;
if (individual == null) {
...
<p>*/
@Override
	public Distraction setAnimalCareConditions(List<IAnimalCareCondition> animalCareConditions){
...
<p>*/
@Override
	public Distraction setInjuryAnaesthesiaAnaesthetics(List<IAnaesthetic> anaesthetics){
...
<p>*/
@Override
	public Distraction setInjuryArea(IInjuryArea injuryArea){
...
<p>*/
@Override
	public Distraction setInjuryDevice(IInjuryDevice injuryDevice){
...
<p>*/
@Override
	public Distraction setInjuryIntensity(IInjuryIntensity injuryIntensity){
...
<p>*/
@Override
	public Distraction setInjuryPostsurgicalCareAnimalCareConditions(List<IAnimalCareCondition> animalCareConditions){
...
<p>*/
@Override
	public Distraction setInjuryVertebralLocation(IVertebralLocation vertebralLocation){
...
<p>*/
@Override
	public Distraction setMedicationDuringSurgeries(List<IMedicationDuringSurgery> medicationDuringSurgeries){
...
<p>*/
@Override
	public Distraction setTemporalIntervals(List<ITemporalInterval> temporalIntervals){
...
@Override
public String toString(){
return "Distraction [individual="+individual+",investigationRestriction="+investigationRestriction.summarize()+",animalCareConditions="+animalCareConditions+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",injuryAnaesthesiaAnaesthetics="+injuryAnaesthesiaAnaesthetics+",injuryArea="+injuryArea+",injuryDevice="+injuryDevice+",injuryIntensity="+injuryIntensity+",injuryPostsurgicalCareAnimalCareConditions="+injuryPostsurgicalCareAnimalCareConditions+",injuryVertebralLocation="+injuryVertebralLocation+",medicationDuringSurgeries="+medicationDuringSurgeries+",serialVersionUID="+serialVersionUID+",temporalIntervals="+temporalIntervals+",textMention="+textMention+"]";}
