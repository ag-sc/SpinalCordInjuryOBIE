...
static class ContactPlacingResponseTestIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/ContactPlacingResponseTest";
...
final private String textMention;
	...
	public ContactPlacingResponseTest(String individualURI, String textMention){
this.individual = 
...
if(contactPlacingResponseTest.getDuration()!=null)this.duration = (IDuration) IOBIEThing.getCloneConstructor(contactPlacingResponseTest.getDuration().getClass())	.newInstance(contactPlacingResponseTest.getDuration());
...
@Override
public String toString(){
return "ContactPlacingResponseTest [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",duration="+duration+",makesUseOfApparatus="+makesUseOfApparatus+",serialVersionUID="+serialVersionUID+",testsForFunctions="+testsForFunctions+",textMention="+textMention+"]";}
