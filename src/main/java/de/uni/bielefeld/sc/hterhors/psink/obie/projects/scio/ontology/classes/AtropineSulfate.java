...
static class AtropineSulfateIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/AtropineSulfate";
...
this.textMention = null;
	...
	public AtropineSulfate(String individualURI, String textMention){
this.individual = 
...
@Override
public String toString(){
return "AtropineSulfate [individual="+individual+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",deliveryMethod="+deliveryMethod+",serialVersionUID="+serialVersionUID+",textMention="+textMention+"]";}
