...
static class PhysicalTreatmentIndividual extends AbstractIndividual {
	...
	public AbstractIndividual getIndividual() {
		return individual;
	}	final static public String ONTOLOGY_NAME = "http://psink.de/scio/PhysicalTreatment";
...
final private String textMention;
	...
	public PhysicalTreatment(String individualURI, String textMention){
this.individual = 
...
if(physicalTreatment.getDuration()!=null)this.duration = (IDuration) IOBIEThing.getCloneConstructor(physicalTreatment.getDuration().getClass())	.newInstance(physicalTreatment.getDuration());
...
@Override
public String toString(){
return "PhysicalTreatment [individual="+individual+",applicationInstrument="+applicationInstrument+",characterOffset="+characterOffset+",characterOnset="+characterOnset+",deliveryMethod="+deliveryMethod+",directions="+directions+",duration="+duration+",frequency="+frequency+",interval="+interval+",location="+location+",serialVersionUID="+serialVersionUID+",temporalIntervals="+temporalIntervals+",textMention="+textMention+"]";}
