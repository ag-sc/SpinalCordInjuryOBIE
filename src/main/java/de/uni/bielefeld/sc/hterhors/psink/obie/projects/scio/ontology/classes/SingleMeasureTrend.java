...
/**
<p><b>rdfs:label</b>
<p>single measure trend
<p>
<p><b>rdfs:description</b>
<p>Single Measure Trend is the outcome of and experiment where only one timepoint per group is investigated.
<p>
*
* @author hterhors
*
...
final public static Class<? extends AbstractIndividual> individualClassType = SingleMeasureTrendIndividual.class;
static class SingleMeasureTrendIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public SingleMeasureTrendIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "SingleMeasureTrendIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<SingleMeasureTrendIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final SingleMeasureTrendIndividual individual;
	@Override
...
if(singleMeasureTrend.getSignificance()!=null)this.significance = (ISignificance) IOBIEThing.getCloneConstructor(singleMeasureTrend.getSignificance().getClass())	.newInstance(singleMeasureTrend.getSignificance());
this.textMention = singleMeasureTrend.getTextMention();
}
...
return false;
SingleMeasureTrend other = (SingleMeasureTrend) obj;
if (individual == null) {
...
<p>*/
@Override
	public SingleMeasureTrend setObservedDifference(IObservedDifference observedDifference){
...
<p>*/
@Override
	public SingleMeasureTrend setSignificance(ISignificance significance){
