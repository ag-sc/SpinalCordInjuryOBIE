...
@DirectSiblings(get={Epidural.class, })

@AssignableSubClasses(get={})

@DirectInterface(get=IEpidural.class)
 public class Epidural implements IEpidural{

final public static IndividualFactory<EpiduralIndividual> individualFactory = new IndividualFactory<>();
final public static Class<? extends AbstractIndividual> individualClassType = EpiduralIndividual.class;
static class EpiduralIndividual extends AbstractIndividual {

	private static final long serialVersionUID = 1L;		public EpiduralIndividual(String namespace, String name) {
			super(namespace, name);
		}

		@Override
		public String toString() {
			return "EpiduralIndividual [name=" + name + ", nameSpace=" + nameSpace + "]";
		}

	}
	public IndividualFactory<EpiduralIndividual> getIndividualFactory() {
		return individualFactory;
	}

	public final EpiduralIndividual individual;
	@Override
...
<p>*/
@Override
	public Epidural setDepth(IDepth depth){
		this.depth = depth;
return this;}
	/**
<p><b>scio:example</b>
...
<p>*/
@Override
	public Epidural setDistance(IDistance distance){
